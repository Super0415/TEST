...
/*                           Hardware Difference                        */
/* ******************************************************************** */
#if    (SCI4_CPU_STM32F1_ON == 1)
#define SCI4_FRQ_CLK           (INT32U)72000000      /* PCLK1 for UART4 */
...
/*  19: Sum of 0~18                                                     */
/* ******************************************************************** */
#define SCI4_BAUDRATE_DEF       2000000
...
SCI4_EXT INT08U SCI4ReadRxBuf(INT16U *pRxBuf);
SCI4_EXT void   SCI4HardInit(INT32U uiBaud);
SCI4_EXT void   SCI4InitTxDma(void);
SCI4_EXT void   SCI4SetupTxDma(INT08U *pAddr, INT16U usSize);
SCI4_EXT void   SCI4InitRxDma(void);
