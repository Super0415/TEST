...
{   /* ************** Part 1: Grid Electric Parameters **************** */
    ...
    usDBpAdcAmpMainVoltA      = 2048;//1024;
    usDBpAdcAmpMainVoltB      = 2048;//1024;
    usDBpAdcAmpMainVoltC      = 2048;//1024;
    usDBpAdcAmpMainVoltAB     = 2048;//1024;
    usDBpAdcAmpMainVoltBC     = 2048;//1024;
    usDBpAdcAmpMainVoltCA     = 2048;//1024;
    usDBpAdcAmpMainCurrA      = 1024;
    usDBpAdcAmpMainCurrB      = 1024;
    usDBpAdcAmpMainCurrC      = 1024;
    usDBpAdcAmpMainCurrGnd    = 1024;
    usDBpAdcAmpGensVoltA      = 2048;//1024;
    usDBpAdcAmpGensVoltB      = 2048;//1024;
    usDBpAdcAmpGensVoltC      = 2048;//1024;
    usDBpAdcAmpGensVoltAB     = 2048;//1024;
    usDBpAdcAmpGensVoltBC     = 2048;//1024;
    usDBpAdcAmpGensVoltCA     = 2048;//1024;
