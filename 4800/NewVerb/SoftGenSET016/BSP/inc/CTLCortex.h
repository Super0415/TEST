...
#define CTL_STS_MSK_ENG_WARM    (INT32U)0x00000008
#define CTL_STS_MSK_MAIN_SW     (INT32U)0x00000010
#define CTL_STS_MSK_GENS_SW     (INT32U)0x00000020
...
#define CTL_MODE_AMF             1
#define CTL_MODE_ISLAND          2
#define CTL_MODE_FIXPOWER        3
#define CTL_MODE_PARALLEL        4
...
/*                          Control Definition                          */
/* ******************************************************************** */
#define CTL_OFFTIME_HEATER      (INT16U)6000
#define CTL_OFFTIME_OILPUMP     (INT16U)6000
#define CTL_MAIN_CURR_ON         0
#define CTL_MAIN_CURR_GND_ON     0
#define CTL_GENS_CURR_ON         1
#define CTL_GENS_CURR_GND_ON     0
#define CTL_LOAD_RAMP_FREQ       50
#define CTL_LOAD_RAMP_STEP_MIN   2
#define CTL_LOAD_OFF_ACT_SETP    2
#define CTL_LOAD_OFF_RCT_SETP    0
#define CTL_REACT_PWR_SETP(r,f) (usDBpLoadReactCtrlMode == 0 ? (r) : \
                                 SFGetReactPwrOfAct(usDBmGensActPowerAll,f))
...
CTL_EXT INT16U CTLGetCommonCmdToSwOn(void);
...
CTL_EXT INT16U CTLGetMainSwCtrl(INT16U usPhase);
CTL_EXT INT16U CTLGetGensSwCtrl(INT16U usPhase);
