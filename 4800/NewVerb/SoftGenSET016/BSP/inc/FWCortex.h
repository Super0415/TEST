...
//@@@@@@@@@@@@@ZC
#define FW_4800_COMMON_ON       0
#define FW_4800_MAIN_CHIP_ON    0
//@@@@@@@@@@@@@ZC
...
//@@@@@@@@ZC
#if   ((FW_VERSION / 100)   == 48)
#undef  FW_4800_COMMON_ON
#define FW_4800_COMMON_ON       1
#endif
#if   ((FW_VERSION / 10)   == 480)
#undef  FW_4800_MAIN_CHIP_ON
#define FW_4800_MAIN_CHIP_ON    1
#endif
...
//@@@@@@@ZC
#if    (FW_4800_COMMON_ON    == 1)
#undef  FW_CPU_STM32F1_ON
#define FW_CPU_STM32F1_ON       1
#endif
#if    (FW_4800_MAIN_CHIP_ON == 1)
#undef  FW_CPU_STM32F103_ON
#define FW_CPU_STM32F103_ON     1
#endif
//@@@@@@@ZC
...
#define FW_SYN_MASK_LCD        (INT32U)0x00000400
//#define FW_SYN_MASK_ALL        (INT32U)0x00000777
#define FW_SYN_MASK_ALL        (INT32U)0x00000773
...
#define FW_SYN_MASK_DB         (INT32U)0x00000100
#define FW_SYN_MASK_FFT        (INT32U)0x00000200
#define FW_SYN_MASK_ALL        (INT32U)0x00000377
#define FW_TASK_STK_SIZE_XIO    128
#define FW_TASK_STK_SIZE_CAN1   128
#define FW_TASK_STK_SIZE_CAN2   128
#define FW_TASK_STK_SIZE_SCI2   128
