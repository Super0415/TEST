...
#define OS_STAT_PRIO            (INT08U)(OS_MAX_TASKS-2)
#define OS_IDLE_PRIO            (INT08U)(OS_MAX_TASKS-1)
...
#define OS_INT_EN()              asm(" CPSIE I")
#define OS_INT_DIS()             asm(" CPSID I")
#endif
#if    (OS_CPU_9S12_ON == 1)
#define OS_CPU_BIG_ENDIAN        1
#define OS_ENTER_CRITICAL()      cpu_sr = OS_CPU_SR_Save()
#define OS_EXIT_CRITICAL()       OS_CPU_SR_Restore(cpu_sr)
...
#define OS_MAX_TASKS             16
#define OS_MAX_EVENTS            16
#define OS_INT_DIS()             asm(" SEI")
#endif
#if    (OS_CPU_POWERPC_ON == 1)
#define OS_CPU_BIG_ENDIAN        1
#define OS_ENTER_CRITICAL()      cpu_sr=OSReadMSR(); asm(" wrteei 0")
#define OS_EXIT_CRITICAL()       OSWriteMSR(cpu_sr)
#define OS_TASK_SW()             asm ("  sc")
#define OS_TICKS_PER_SEC         200
#define OS_MAX_TASKS             16
#define OS_MAX_EVENTS            16
#define OS_INT_EN()              asm(" wrteei 1")
#define OS_INT_DIS()             asm(" wrteei 0")
#endif
...
{   struct os_event *pOSEventNext;
    ...
    INT16U           usOSEventCnt;
   #if (OS_MAX_TASKS == 16)
    OS_DBYTE         dbOSEventIndex;
   #elif (OS_MAX_TASKS == 32)
    OS_QBYTE         qbOSEventIndex;
   #endif
}   OS_EVENT;
...
#if (OS_CPU_9S12_ON == 1)
OS_EXT INT08U   ucOSGpageTemp;
#endif
OS_EXT INT08U   ucOSRunning;
OS_EXT INT08U   ucOSIntNesting;
OS_EXT INT08U   ucOSPrioCur;
OS_EXT INT08U   ucOSPrioHighRdy;
OS_EXT INT16U   usOSCPUUsage;
OS_EXT INT16U   usOSTimeOverCnt;
#if (OS_MAX_TASKS == 16)
OS_EXT OS_DBYTE dbOSRdyIndex;
#elif (OS_MAX_TASKS == 32)
OS_EXT OS_QBYTE qbOSRdyIndex;
#endif
OS_EXT INT32U   uiOSIdleCtrMax;
OS_EXT INT32U   uiOSIdleCtr;
OS_EXT INT32U   uiOSTime;
OS_EXT OS_TCB   *pOSTCBHighRdy;
OS_EXT OS_TCB   *pOSTCBCur;
OS_EXT OS_TCB   *pOSTCBFree;
OS_EXT OS_TCB   *pOSTCBPrioTbl[OS_MAX_TASKS];
OS_EXT OS_TCB   sOSTCBTbl[OS_MAX_TASKS];
OS_EXT OS_EVENT *pOSEventFreeList;
OS_EXT OS_EVENT sOSEventTbl[OS_MAX_EVENTS];
#endif
