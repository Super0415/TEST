...
/*  FFT_VERSION  = 760x: GEC7600-Main Application                       */
/*  FFT_VERSION  = 761x: GEC7600-Display Application                    */
/*  FFT_VERSION  = 780x: GEC7800-Main Application                       */
/*  FFT_VERSION  = 781x: GEC7800-Display Application                    */
/*  FFT_VERSION  = 80xx: VEC8000 Application                            */
/*  FFT_VERSION  = 90xx: VEC9000 Application                            */
/*  FFT_VERSION  = 96xx: VEC9600 Application                            */
/* ******************************************************************** */

#define FFT_VERSION           7800
...
#define FFT_7600_MAIN_CHIP_ON    0
#define FFT_7600_AUX_CHIP_ON     0
#define FFT_7800_COMMON_ON       0
#define FFT_7800_MAIN_CHIP_ON    0
#define FFT_7800_AUX_CHIP_ON     0
...
#endif
#if   ((FFT_VERSION / 10)   == 760)
#undef  FFT_7600_MAIN_CHIP_ON
#define FFT_7600_MAIN_CHIP_ON    1
#endif
#if   ((FFT_VERSION / 10)   == 761)
#undef  FFT_7600_AUX_CHIP_ON
#define FFT_7600_AUX_CHIP_ON     1
#endif
#if   ((FFT_VERSION / 100)   == 78)
#undef  FFT_7800_COMMON_ON
#define FFT_7800_COMMON_ON       1
#endif
#if   ((FFT_VERSION / 10)   == 780)
#undef  FFT_7800_MAIN_CHIP_ON
#define FFT_7800_MAIN_CHIP_ON    1
#endif
#if   ((FFT_VERSION / 10)   == 781)
#undef  FFT_7800_AUX_CHIP_ON
#define FFT_7800_AUX_CHIP_ON     1
#endif
...
#define FFT_CPU_STM32F103_ON     0
#define FFT_CPU_STM32F105_ON     0
...
#endif
#if    (FFT_7600_MAIN_CHIP_ON == 1)
#undef  FFT_CPU_STM32F105_ON
#define FFT_CPU_STM32F105_ON     1
#undef  FFT_FFT_FUNCTION_ON
#define FFT_FFT_FUNCTION_ON      1
#endif
#if    (FFT_7600_AUX_CHIP_ON  == 1)
#undef  FFT_CPU_STM32F103_ON
#define FFT_CPU_STM32F103_ON     1
#endif
...
#define FFT_FFT_FUNCTION_ON      1
#endif
#if    (FFT_7800_MAIN_CHIP_ON == 1)
#undef  FFT_CPU_STM32F105_ON
#define FFT_CPU_STM32F105_ON     1
#endif
#if    (FFT_7800_AUX_CHIP_ON  == 1)
#undef  FFT_CPU_STM32F103_ON
#define FFT_CPU_STM32F103_ON     1
#endif
...
#define FFT_STS_NORMAL         (INT32U)0x00000000
#define FFT_STS_BUFF_BUSY      (INT32U)0x00000001
#define FFT_STS_FFT_FINISH     (INT32U)0x00000002
#define FFT_STS_GET_BIT(m)     (uiFFTStatus & (m))
#define FFT_STS_CLR_BIT(m)      uiFFTStatus &= ~(m)
#define FFT_STS_SET_BIT(m)      uiFFTStatus |= (m)
...
#define FFT_DISTORTION_32F_ON   0
...
FFT_EXT INT32U uiFFTStatus;
FFT_EXT INT16U usFFTCalcTime;
FFT_EXT FFT_RING_STR sFFTRingBuf;
FFT_EXT INT16S ssFFTDatInput[FFT_FFT_DAT_SIZE];
...
FFT_EXT void   FFTCopy16sToCmplx(INT16S *pSour, FP32 *pDest, INT16U usSize);
FFT_EXT void   FFTFillTestData(FP32 *pDest, INT16U usSize);
FFT_EXT void   FFTUpdateSpectrum(FP32 *pSour, INT16U *pDest, INT16U usSize);
FFT_EXT void   FFTUpdateFilter(FP32 *pSour, FP32 *pFilt, INT16U usSize);
FFT_EXT INT16U FFTDistortion32f(FP32 *pDat, INT16U usSize);
FFT_EXT INT16U FFTDistortion16u(INT16U *pDat, INT16U usSize);
