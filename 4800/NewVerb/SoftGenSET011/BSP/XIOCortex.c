...
{   uiXIOStatus = 0;
    ...
    (void)XIOInitTim2();
    (void)XIOInitTim3();
//    (void)XIOInitTim3FrqIn();     //TIM3 重映像端口冲突
    (void)XIOInitTim4();
...
{
//    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOF|RCC_APB2Periph_AFIO, (FunctionalState)ENABLE);
//	
...
////       XIOConfigREMAP(AFIO_MAPR_SWJ_CFG_JTAGDISABLE,0);
    ...
    XIOConfigGPIO(XIO_PT_LED_SW_ENTER,   XIO_BT_LED_SW_ENTER,   XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_SW_UP,      XIO_BT_LED_SW_UP,      XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_SW_DOWN,    XIO_BT_LED_SW_DOWN,    XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_SW_RUN,     XIO_BT_LED_SW_RUN,     XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_SW_MAINTEN, XIO_BT_LED_SW_MAINTEN, XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_SW_ALARM,   XIO_BT_LED_SW_ALARM,   XIO_PT_GPO_PP_02M, XIO_PT_SET_0);    
