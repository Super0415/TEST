...
/*  CCP_VERSION  = 760x: GEC7600-Main Application                       */
/*  CCP_VERSION  = 761x: GEC7600-Display Application                    */
/*  CCP_VERSION  = 780x: GEC7800-Main Application                       */
/*  CCP_VERSION  = 781x: GEC7800-Display Application                    */
/*  CCP_VERSION  = 80xx: VEC8000 Application                            */
/*  CCP_VERSION  = 90xx: VEC9000 Application                            */
/*  CCP_VERSION  = 96xx: VEC9600 Application                            */
/* ******************************************************************** */

#define CCP_VERSION           7800
...
#define CCP_7600_MAIN_CHIP_ON    0
#define CCP_7600_AUX_CHIP_ON     0
#define CCP_7800_COMMON_ON       0
#define CCP_7800_MAIN_CHIP_ON    0
#define CCP_7800_AUX_CHIP_ON     0
...
#endif
#if   ((CCP_VERSION / 10)   == 760)
#undef  CCP_7600_MAIN_CHIP_ON
#define CCP_7600_MAIN_CHIP_ON    1
#endif
#if   ((CCP_VERSION / 10)   == 761)
#undef  CCP_7600_AUX_CHIP_ON
#define CCP_7600_AUX_CHIP_ON     1
#endif
#if   ((CCP_VERSION / 100)   == 78)
#undef  CCP_7800_COMMON_ON
#define CCP_7800_COMMON_ON       1
#endif
#if   ((CCP_VERSION / 10)   == 780)
#undef  CCP_7800_MAIN_CHIP_ON
#define CCP_7800_MAIN_CHIP_ON    1
#endif
#if   ((CCP_VERSION / 10)   == 781)
#undef  CCP_7800_AUX_CHIP_ON
#define CCP_7800_AUX_CHIP_ON     1
#endif
...
#define CCP_CPU_STM32F103_ON     0
#define CCP_CPU_STM32F105_ON     0
...
#endif
#if    (CCP_7600_MAIN_CHIP_ON == 1)
#undef  CCP_CPU_STM32F105_ON
#define CCP_CPU_STM32F105_ON     1
#endif
#if    (CCP_7600_AUX_CHIP_ON  == 1)
#undef  CCP_CPU_STM32F103_ON
#define CCP_CPU_STM32F103_ON     1
#endif
#if    (CCP_7800_COMMON_ON    == 1)
#undef  CCP_CPU_STM32F1_ON
#define CCP_CPU_STM32F1_ON       1
#endif
#if    (CCP_7800_MAIN_CHIP_ON == 1)
#undef  CCP_CPU_STM32F105_ON
#define CCP_CPU_STM32F105_ON     1
#endif
#if    (CCP_7800_AUX_CHIP_ON  == 1)
#undef  CCP_CPU_STM32F103_ON
#define CCP_CPU_STM32F103_ON     1
#endif
...
CCP_EXT INT08U CCPCanIsRxEmpty(void);
