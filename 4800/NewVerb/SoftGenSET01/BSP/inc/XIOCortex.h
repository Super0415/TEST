...
#define XIO_GPI_PT_KEY_START     PC6
#define XIO_PT_KEY_START         GPIOC
#define XIO_BT_KEY_START         6
#define XIO_GET_KEY_START()     (XIO_PT_KEY_START->IDR & (1<<XIO_BT_KEY_START))
#define XIO_GPI_PT_KEY_NOISE     PD10
#define XIO_PT_KEY_NOISE         GPIOD
#define XIO_BT_KEY_NOISE         10
#define XIO_GET_KEY_NOISE()     (XIO_PT_KEY_NOISE->IDR & (1<<XIO_BT_KEY_NOISE))
#define XIO_GPI_PT_KEY_SW_ON     PE10
#define XIO_PT_KEY_SW_ON         GPIOE
#define XIO_BT_KEY_SW_ON         10
#define XIO_GET_KEY_SW_ON()     (XIO_PT_KEY_SW_ON->IDR & (1<<XIO_BT_KEY_SW_ON))
#define XIO_GPI_PT_KEY_SW_OFF    PE12
#define XIO_PT_KEY_SW_OFF        GPIOE
#define XIO_BT_KEY_SW_OFF        12
#define XIO_GET_KEY_SW_OFF()    (XIO_PT_KEY_SW_OFF->IDR & (1<<XIO_BT_KEY_SW_OFF))

/* ******************************************************************** */
/*                            Switch Inputs                             */
/* ******************************************************************** */
#define XIO_NUM_OF_DIN           5
#define XIO_GPI_PT_DIN_CH1       PC9
#define XIO_PT_DIN_CH1           GPIOC
#define XIO_BT_DIN_CH1           9
...
#define XIO_GPO_PT_LED_AUTO      PE6
#define XIO_PT_LED_AUTO          GPIOE
...
#define XIO_GPO_PT_LED_MANUAL    PC13
#define XIO_PT_LED_MANUAL        GPIOC
#define XIO_BT_LED_MANUAL        13
...
#define XIO_GPO_PT_LED_NOISE     PD9
#define XIO_PT_LED_NOISE         GPIOD
#define XIO_BT_LED_NOISE         9
...
#define XIO_GPO_PT_LED_SW_ON     PA15
#define XIO_PT_LED_SW_ON         GPIOA
#define XIO_BT_LED_SW_ON         15
...
#define XIO_GPO_PT_LED_SW_OFF    PE11
#define XIO_PT_LED_SW_OFF        GPIOE
#define XIO_BT_LED_SW_OFF        11
...
#define XIO_GPO_PT_DOUT_CH3      PA10
#define XIO_PT_DOUT_CH3          GPIOA
#define XIO_BT_DOUT_CH3          10
...
#define XIO_GPO_PT_DOUT_CH6      PD4
#define XIO_PT_DOUT_CH6          GPIOD
#define XIO_BT_DOUT_CH6          4
...
#define XIO_GPO_PT_DOUT_CH8      PE8
#define XIO_PT_DOUT_CH8          GPIOE
