...
{   XIOConfigGPIO(XIO_PT_KEY_RESET,  XIO_BT_KEY_RESET,  XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    ...
    XIOConfigGPIO(XIO_PT_KEY_NOISE,  XIO_BT_KEY_NOISE,  XIO_PT_GPI_PULL,  XIO_PT_SET_1);
...
{   XIOConfigGPIO(XIO_PT_LED_RESET,  XIO_BT_LED_RESET,  XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_AUTO,   XIO_BT_LED_AUTO,   XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_MANUAL, XIO_BT_LED_MANUAL, XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_STOP,   XIO_BT_LED_STOP,   XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_START,  XIO_BT_LED_START,  XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_NOISE,  XIO_BT_LED_NOISE,  XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_SW_ON,  XIO_BT_LED_SW_ON,  XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
    XIOConfigGPIO(XIO_PT_LED_SW_OFF, XIO_BT_LED_SW_OFF, XIO_PT_GPO_PP_02M, XIO_PT_SET_0);
