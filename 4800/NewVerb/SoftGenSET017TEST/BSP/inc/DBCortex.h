...
#define usDBmEngSpeed              (*((INT16U*)aDBMeasu+ 80))  //发动机转速
#define usDBmEngSpeedPickup1       (*((INT16U*)aDBMeasu+ 81))
#define usDBmEngSpeedPickup2       (*((INT16U*)aDBMeasu+ 82))
#define usDBmEngEngineIsStopped    (*((INT16U*)aDBMeasu+ 83))  //机组处于停机状态
#define usDBmEngEngineIsRunning    (*((INT16U*)aDBMeasu+ 84))  //机组处于运行状态
#define usDBmEngEngineIsIdling     (*((INT16U*)aDBMeasu+ 85))  //机组处于怠速状态
...
#define usDBmSysEmergnCmdToStop    (*((INT16U*)aDBMeasu+100))  //系统停机指令
...
#define usDBmBoardLedOutput        (*((INT16U*)aDBMeasu+206))    //面板led输出1
#define usDBmBoardLedOutput2       (*((INT16U*)aDBMeasu+207))    //面板led输出1
...
#define uiDBmBoardLedOutput        (*((INT32U*)(&usDBmBoardLedOutput)))  //面板led输出总

/* **************** Part 10: Digital Inputs *************************** */
#define usDBmKeyMenuUp             (*((INT16U*)aDBMeasu+208))  //向上
#define usDBmKeyMenuDown           (*((INT16U*)aDBMeasu+209))  //向下
#define usDBmKeyMenuRight          (*((INT16U*)aDBMeasu+210))
#define usDBmKeyMenuLeft           (*((INT16U*)aDBMeasu+211))
#define usDBmKeyMenuEnter          (*((INT16U*)aDBMeasu+212))  //确认
#define usDBmKeyOBD                (*((INT16U*)aDBMeasu+213))
#define usDBmKeyEngineStop         (*((INT16U*)aDBMeasu+214))  //停机
#define usDBmKeyEngineStart        (*((INT16U*)aDBMeasu+215))  //起机
#define usDBmKeyModeAuto           (*((INT16U*)aDBMeasu+216))  //自动
#define usDBmKeyModeManual         (*((INT16U*)aDBMeasu+217))  //手动
#define usDBmKeyErrorReset         (*((INT16U*)aDBMeasu+218))  //复位
#define usDBmKeySwitchOn           (*((INT16U*)aDBMeasu+219))  //发电合闸
#define usDBmKeySwitchOff          (*((INT16U*)aDBMeasu+220))  //市电合闸
#define usDBmKeyBeeperOff          (*((INT16U*)aDBMeasu+221))  //消音 
...
#define usDBmSwitchEmergStop       (*((INT16U*)aDBMeasu+237))    //开关量功能项-停机
