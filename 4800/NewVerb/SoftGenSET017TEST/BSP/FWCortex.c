...
/* ******************************************************************** */
//@@@@@@@@@@@@@@@@@@@@@@@   程序运行测试   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@
//  0-XIOTaskLoop-OK  1-CAN1TaskLoop-OK  2-CAN2TaskLoop-NO  3-SCI1TaskLoop-NO
//  4-SCI2TaskLoop-OK  5-SCI3TaskLoop-OK  6-SCI4TaskLoop-OK  7-SCI5TaskLoop-NO
//  8-DBTaskLoop-OK  9-FFTTaskLoop-OK  10-SPI1TaskLoop-NO  11-SPI2TaskLoop-NO
//  12-SPI3TaskLoop-NO  13-SDIOTaskLoop-NO  14-LCDTaskLoop-OK
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
int NumTemp[50];
#define TEST_ZC  0
#define TEST_ZC_ADC3  1
int main (void)
{    
#if(TEST_ZC==1)  
#if(TEST_ZC_ADC3!=1)  
    ...
    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOF|RCC_APB2Periph_GPIOA|RCC_APB2Periph_AFIO|RCC_APB2Periph_ADC3|RCC_APB2Periph_ADC1,(FunctionalState)ENABLE);
 ...
 //   XIOConfigGPIO(GPIOF, XIO_PT_BT1, XIO_PT_GPO_PP_10M, XIO_PT_SET_1);   // PF1  转速控制端口  
    ...
    while(ADC_GetResetCalibrationStatus(ADC1));//获取重置的ADC校准寄存器的状态
	
    ADC_StartCalibration(ADC1);//开始指定ADC校准寄存器的状态
    while(ADC_GetCalibrationStatus(ADC1));//获取ADC校准程序

    ADC_SoftwareStartConvCmd(ADC1, (FunctionalState)ENABLE);//使能或失能指定的ADC的软件转换启动功能
#endif  
#if(TEST_ZC_ADC3==1)   
    GPIO_InitTypeDef GPIO_InitStructure;
    ADC_InitTypeDef ADC_InitStructure;
    ...
    #endif
    #ifdef FW_TASK_PRIO_CAN2   //No
    (void)CAN2Init();                        /* Initialize CAN2 Model   */
    #endif
    #ifdef FW_TASK_PRIO_SCI1  //No
 ...
 {    
    ...
    NumTemp[46] = ad;    
        ...
        NumTemp[48] = 1000000;
        while(NumTemp[48]--);
        NumTemp[47] = GPIO_ReadOutputDataBit(GPIOF, GPIO_Pin_1);
...
void DMA2_Channel4_5_IRQHandler (void)   //@@@@@@@@@@@@ZC
{   
//  FW_STS_SET_BIT(FW_STS_INTERRUPT);
    (void)OSIntEnter();
    #ifdef FW_TASK_PRIO_SCI4
...
/* ******************************************************************** */
#if (FW_CPU_STM32F103_ON == 1)
void USB_HP_CAN1_TX_IRQHandler (void)    //@@@@@@@@@ZC  CAN1_TX_IRQHandler 
{   
//  FW_STS_SET_BIT(FW_STS_INTERRUPT);
    (void)OSIntEnter();
    (void)CAN1TxIntHook();
...
void USB_LP_CAN1_RX0_IRQHandler (void)   //@@@@@@@@@ZC  CAN1_RX0_IRQHandler  
{   
//  FW_STS_SET_BIT(FW_STS_INTERRUPT);
    (void)OSIntEnter();
    (void)CAN1Rx0IntHook();
