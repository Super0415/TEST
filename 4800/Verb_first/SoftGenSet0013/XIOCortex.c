...
void XIOInitDigInput (void)
{
  ...
  */
   ...
   XIOConfigGPIOKEY(GPIOC, XIO_PT_BT10, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //键 PC10
   XIOConfigGPIOKEY(GPIOB, XIO_PT_BT5, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //键 PB5
   XIOConfigGPIOKEY(GPIOB, XIO_PT_BT12, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //键 PB12
   XIOConfigGPIOKEY(GPIOB, XIO_PT_BT10, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //键 PB10
