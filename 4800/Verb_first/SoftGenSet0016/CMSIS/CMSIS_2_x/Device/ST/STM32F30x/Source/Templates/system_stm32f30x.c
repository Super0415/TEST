...
#include "stm32f30x.h"
#include "Function.h"
#include "Global_Variables.h" // + by ivt on 2014.7.11PM
...
#define CCMRAM_BASE             ((uint32_t)0x10000000u) /*!< CCMRAM base address*/
...
#else
static void SetSysClock_HSI(void); // Modified by ivt on 2014.7.11PM
#endif
...
void SystemInit(void)
{
  ...
  SetSysClock();
#else
  SetSysClock_HSI(); // + by ivt on 2014.7.11PM
#endif
  ...
  RCC->AHBENR |= RCC_AHBPeriph_CRC;
...
#ifdef IEC60335
  #if defined (STL_VERBOSE) && defined (STL_EVAL_MODE)
    /* Verbose messages ------------------------------------------------------*/
    STL_VerbosePORInit();
    //USART_ReConfigurationClk(72);
    //printf("\n\r %s\n\r", MESSAGE1);
    //printf(" %s\n\r", MESSAGE2);
    ...
    //LCD_DisplayStringLine(LCD_LINE_2, "StartUp test OK     ");
    //LCD_DisplayStringLine(LCD_LINE_3, "Main entry...       ");
    
    /* stop IWDG at break in debug mode */
    #ifdef USE_INDEPENDENT_WDOG
      DBGMCU->APB1FZ |= DBGMCU_IWDG_STOP;
    #endif /* USE_INDEPENDENT_WDOG */
      
    /* stop WWDG at break in debug mode */
  ...
  #endif /* STL_VERBOSE & STL_EVAL_MODE */
#endif  
}
...
/******************************************************************************/
  ...
  else
  {
    ...
    gMotorVars[M1].Fault_Type=MC_FAULT_HSE_STARTUP_FAILURE; // + by ivt on 2014.7.11
  }
...
/******************************************************************************/
  ...
  else
  {
    ...
    gMotorVars[M1].Fault_Type=MC_FAULT_HSI_STARTUP_FAILURE; // + by ivt on 2014.7.11
  }
