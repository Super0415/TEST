...
/* ************** Part 8: Sensor Assignment (213 - 242) *************** */  //传感器分配-对应采样数组序号
...
#define	usDBpAssignOilPress        (*((INT16U*)aDBParam+218))    //油压选择 默认采样数组序号10
...
#define	usDBpOilPressSenType       (*((INT16U*)aDBParam+260))   //油压传感器类型选择
...
#define	usDBpDigitalOut1Assign     (*((INT16U*)aDBParam+300))               //输出口1分配
#define	usDBpDigitalOut2Assign     (*((INT16U*)aDBParam+301))               //输出口2分配
#define	usDBpDigitalOut3Assign     (*((INT16U*)aDBParam+302))               //输出口3分配
#define	usDBpDigitalOut4Assign     (*((INT16U*)aDBParam+303))               //输出口4分配
...
#define usDBmAdcInput0             (*((INT16U*)aDBMeasu+ 76))   //AD通道0采集平均值
#define usDBmAdcInput1             (*((INT16U*)aDBMeasu+ 77))   //AD通道1采集平均值
#define usDBmAdcInput2             (*((INT16U*)aDBMeasu+ 78))   //AD通道2采集平均值
...
#define usDBmAdcInput15            (*((INT16U*)aDBMeasu+ 91))   //AD通道15采集平均值
...
#define	usDBmKeyMenuUp             (*((INT16U*)aDBMeasu+104))    //面板按键-向上键
#define	usDBmKeyMenuDown           (*((INT16U*)aDBMeasu+105))    //面板按键-向下键
#define	usDBmKeyMenuRight          (*((INT16U*)aDBMeasu+106))
#define	usDBmKeyMenuLeft           (*((INT16U*)aDBMeasu+107))
#define	usDBmKeyMenuEnter          (*((INT16U*)aDBMeasu+108))    //面板按键-确认键
#define	usDBmKeyOBD                (*((INT16U*)aDBMeasu+109))
#define	usDBmKeyEngineStop         (*((INT16U*)aDBMeasu+110))   //面板按键-停机键
#define	usDBmKeyEngineStart        (*((INT16U*)aDBMeasu+111))   //面板按键-起机键
#define	usDBmKeyModeAuto           (*((INT16U*)aDBMeasu+112))   //面板按键-自动键
#define	usDBmKeyModeManual         (*((INT16U*)aDBMeasu+113))   //面板按键-手动键
#define	usDBmKeyErrorReset         (*((INT16U*)aDBMeasu+114))   //面板按键-复位键
