...
#define usDBfRS485SysMode           (*((INT16U*)aDBFunct+  0))  //485运行模式 0-主机 1-监听机
...
#define usDBmRS485S             (*((INT16U*)aDBMeasu+  0))  //
...
#define usDBhCANRXToLeng           (*((INT16U*)aDBMeasu+200))  //CAN数据总长度
#define usDBhCANRXBuff              (((INT16U*)aDBMeasu+201))  //CAN数据起始地址
/* ******************************************************************** */
