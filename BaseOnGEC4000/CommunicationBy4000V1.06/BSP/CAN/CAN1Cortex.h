...
#define CAN1_MY_ADDRESS_DEF     0x23
#define CAN1_BAUDRATE_DEF       250
...
#define CAN1_GPO_PT_CANTX       PA12
#define CAN1_GPI_PT_CANRX       PA11
#define CAN1_TX_PT              GPIOA
#define CAN1_TX_BT              12
#define CAN1_RX_PT              GPIOA
#define CAN1_RX_BT              11
...
CAN1_EXT CCP_CCP10_STR sCCP10RxPar;
CAN1_EXT CCP_CCP10_STR sCCP10TxReq;

CAN1_EXT void   CAN1TxData (void);
...
CAN1_EXT void   CAN1PutRxMsgToBuf(CAN_MSG *pmsg);
CAN1_EXT INT08U CAN1GetTxMsgFmBuf(CAN_MSG *pmsg);
CAN1_EXT INT08U CAN1GetMsgFmRxBuf(INT16U to, CAN_MSG *pmsg);
CAN1_EXT INT08U CAN1PutMsgToTxBuf(INT16U to, CAN_MSG *pmsg);
CAN1_EXT void   CAN1HardInit(INT32U uiBaud);
CAN1_EXT void   CCP10DecodeRxPar (CAN_MSG *pMsg);
CAN1_EXT void   CCP10FillMsgTxReq (CAN_MSG *pMsg);
