...
#define usDBfCANEnable              (*((INT16U*)aDBFunct+  20))   //CAN 使能
#define usDBfCANEnSentData0         (*((INT16U*)aDBFunct+  21))   //CAN 第1条信息发送使能
#define usDBfCANEnSentData1         (*((INT16U*)aDBFunct+  22))   //CAN 第2条信息发送使能
#define usDBfCANEnSentData2         (*((INT16U*)aDBFunct+  23))   //CAN 第3条信息发送使能
#define usDBfCANEnSentData3         (*((INT16U*)aDBFunct+  24))   //CAN 第4条信息发送使能
#define usDBfCANEnSentData4         (*((INT16U*)aDBFunct+  25))   //CAN 第5条信息发送使能
#define usDBfCANEnSentData5         (*((INT16U*)aDBFunct+  26))   //CAN 第6条信息发送使能
#define usDBfCANEnSentData6         (*((INT16U*)aDBFunct+  27))   //CAN 第7条信息发送使能
#define usDBfCANEnSentData7         (*((INT16U*)aDBFunct+  28))   //CAN 第8条信息发送使能
#define usDBfCANEnSentData8         (*((INT16U*)aDBFunct+  29))   //CAN 第9条信息发送使能

#define usDBfSysBackup              (*((INT16U*)aDBFunct+  30))   //数据保存功能  1-保存所以数据  2-清除485缓存报文数据  3-清除CAN缓存报文数据
/* ******************************************************************** */
...
#define usDBcCANTTX0Data0               (*((INT16U*)aDBCurve+ 180)) //第1条报文-CAN
#define usDBcCANTTX0Data1               (*((INT16U*)aDBCurve+ 181))
#define usDBcCANTTX0Data2               (*((INT16U*)aDBCurve+ 182))
#define usDBcCANTTX0Data3               (*((INT16U*)aDBCurve+ 183))
#define usDBcCANTTX0Data4               (*((INT16U*)aDBCurve+ 184))
#define usDBcCANTTX0Data5               (*((INT16U*)aDBCurve+ 185))
#define usDBcCANTTX0Data6               (*((INT16U*)aDBCurve+ 186))
#define usDBcCANTTX0Data7               (*((INT16U*)aDBCurve+ 187))

#define usDBcCANTTX1Data0               (*((INT16U*)aDBCurve+ 190)) //第2条报文-CAN
#define usDBcCANTTX1Data1               (*((INT16U*)aDBCurve+ 191))
#define usDBcCANTTX1Data2               (*((INT16U*)aDBCurve+ 192))
#define usDBcCANTTX1Data3               (*((INT16U*)aDBCurve+ 193))
#define usDBcCANTTX1Data4               (*((INT16U*)aDBCurve+ 194))
#define usDBcCANTTX1Data5               (*((INT16U*)aDBCurve+ 195))
#define usDBcCANTTX1Data6               (*((INT16U*)aDBCurve+ 196))
#define usDBcCANTTX1Data7               (*((INT16U*)aDBCurve+ 197))

#define usDBcCANTTX2Data0               (*((INT16U*)aDBCurve+ 200)) //第3条报文-CAN
#define usDBcCANTTX2Data1               (*((INT16U*)aDBCurve+ 201))
#define usDBcCANTTX2Data2               (*((INT16U*)aDBCurve+ 202))
#define usDBcCANTTX2Data3               (*((INT16U*)aDBCurve+ 203))
#define usDBcCANTTX2Data4               (*((INT16U*)aDBCurve+ 204))
#define usDBcCANTTX2Data5               (*((INT16U*)aDBCurve+ 205))
#define usDBcCANTTX2Data6               (*((INT16U*)aDBCurve+ 206))
#define usDBcCANTTX2Data7               (*((INT16U*)aDBCurve+ 207))

#define usDBcCANTTX3Data0               (*((INT16U*)aDBCurve+ 210)) //第4条报文-CAN
#define usDBcCANTTX3Data1               (*((INT16U*)aDBCurve+ 211))
#define usDBcCANTTX3Data2               (*((INT16U*)aDBCurve+ 212))
#define usDBcCANTTX3Data3               (*((INT16U*)aDBCurve+ 213))
#define usDBcCANTTX3Data4               (*((INT16U*)aDBCurve+ 214))
#define usDBcCANTTX3Data5               (*((INT16U*)aDBCurve+ 215))
#define usDBcCANTTX3Data6               (*((INT16U*)aDBCurve+ 216))
#define usDBcCANTTX3Data7               (*((INT16U*)aDBCurve+ 217))

#define usDBcCANTTX4Data0               (*((INT16U*)aDBCurve+ 220)) //第5条报文-CAN
#define usDBcCANTTX4Data1               (*((INT16U*)aDBCurve+ 221))
#define usDBcCANTTX4Data2               (*((INT16U*)aDBCurve+ 222))
#define usDBcCANTTX4Data3               (*((INT16U*)aDBCurve+ 223))
#define usDBcCANTTX4Data4               (*((INT16U*)aDBCurve+ 224))
#define usDBcCANTTX4Data5               (*((INT16U*)aDBCurve+ 225))
#define usDBcCANTTX4Data6               (*((INT16U*)aDBCurve+ 226))
#define usDBcCANTTX4Data7               (*((INT16U*)aDBCurve+ 227))

#define usDBcCANTTX5Data0               (*((INT16U*)aDBCurve+ 230)) //第6条报文-CAN
#define usDBcCANTTX5Data1               (*((INT16U*)aDBCurve+ 231))
#define usDBcCANTTX5Data2               (*((INT16U*)aDBCurve+ 232))
#define usDBcCANTTX5Data3               (*((INT16U*)aDBCurve+ 233))
#define usDBcCANTTX5Data4               (*((INT16U*)aDBCurve+ 234))
#define usDBcCANTTX5Data5               (*((INT16U*)aDBCurve+ 235))
#define usDBcCANTTX5Data6               (*((INT16U*)aDBCurve+ 236))
#define usDBcCANTTX5Data7               (*((INT16U*)aDBCurve+ 237))

#define usDBcCANTTX6Data0               (*((INT16U*)aDBCurve+ 240)) //第7条报文-CAN
#define usDBcCANTTX6Data1               (*((INT16U*)aDBCurve+ 241))
#define usDBcCANTTX6Data2               (*((INT16U*)aDBCurve+ 242))
#define usDBcCANTTX6Data3               (*((INT16U*)aDBCurve+ 243))
#define usDBcCANTTX6Data4               (*((INT16U*)aDBCurve+ 244))
#define usDBcCANTTX6Data5               (*((INT16U*)aDBCurve+ 245))
#define usDBcCANTTX6Data6               (*((INT16U*)aDBCurve+ 246))
#define usDBcCANTTX6Data7               (*((INT16U*)aDBCurve+ 247))

#define usDBcCANTTX7Data0               (*((INT16U*)aDBCurve+ 250)) //第8条报文-CAN
#define usDBcCANTTX7Data1               (*((INT16U*)aDBCurve+ 251))
#define usDBcCANTTX7Data2               (*((INT16U*)aDBCurve+ 252))
#define usDBcCANTTX7Data3               (*((INT16U*)aDBCurve+ 253))
#define usDBcCANTTX7Data4               (*((INT16U*)aDBCurve+ 254))
#define usDBcCANTTX7Data5               (*((INT16U*)aDBCurve+ 255))
#define usDBcCANTTX7Data6               (*((INT16U*)aDBCurve+ 256))
#define usDBcCANTTX7Data7               (*((INT16U*)aDBCurve+ 257))

#define usDBcCANTTX8Data0               (*((INT16U*)aDBCurve+ 260)) //第9条报文-CAN
#define usDBcCANTTX8Data1               (*((INT16U*)aDBCurve+ 261))
#define usDBcCANTTX8Data2               (*((INT16U*)aDBCurve+ 262))
#define usDBcCANTTX8Data3               (*((INT16U*)aDBCurve+ 263))
#define usDBcCANTTX8Data4               (*((INT16U*)aDBCurve+ 264))
#define usDBcCANTTX8Data5               (*((INT16U*)aDBCurve+ 265))
#define usDBcCANTTX8Data6               (*((INT16U*)aDBCurve+ 266))
#define usDBcCANTTX8Data7               (*((INT16U*)aDBCurve+ 267))
/* ******************************************************************** */
/*                        Measurement Definition                        */
/* ******************************************************************** */
/* **************** Part 1: Grid Electric Measurements **************** */
#define usDBmKeyMenuUp             (*((INT16U*)aDBMeasu+  0))  //向上
#define usDBmKeyMenuDown           (*((INT16U*)aDBMeasu+  1))  //向下
#define usDBmKeyMenuRight          (*((INT16U*)aDBMeasu+  2))  //向右
#define usDBmKeyMenuLeft           (*((INT16U*)aDBMeasu+  3))  //向左
#define usDBmKeyMenuEnter          (*((INT16U*)aDBMeasu+  4))  //确定
#define usDBmKeyEngineStop         (*((INT16U*)aDBMeasu+  5))  //停机
#define usDBmKeyEngineStart        (*((INT16U*)aDBMeasu+  6))  //开机
#define usDBmKeyModeAuto           (*((INT16U*)aDBMeasu+  7))  //自动
#define usDBmKeyModeManual         (*((INT16U*)aDBMeasu+  8))  //手动
#define usDBmKeyErrorReset         (*((INT16U*)aDBMeasu+  9))  //复位

#define usDBmRS485Msg0Norma0       (*((INT16U*)aDBMeasu+  20))  //RS485通讯0正常
#define usDBmRS485Msg0Norma1       (*((INT16U*)aDBMeasu+  21))  //RS485通讯1正常
#define usDBmRS485Msg0Norma2       (*((INT16U*)aDBMeasu+  22))  //RS485通讯2正常
#define usDBmRS485Msg0Norma3       (*((INT16U*)aDBMeasu+  23))  //RS485通讯3正常
#define usDBmRS485Msg0Norma4       (*((INT16U*)aDBMeasu+  24))  //RS485通讯4正常
#define usDBmRS485Msg0Norma5       (*((INT16U*)aDBMeasu+  25))  //RS485通讯5正常
#define usDBmRS485Msg0Norma6       (*((INT16U*)aDBMeasu+  26))  //RS485通讯6正常
#define usDBmRS485Msg0Norma7       (*((INT16U*)aDBMeasu+  27))  //RS485通讯7正常
#define usDBmRS485Msg0Norma8       (*((INT16U*)aDBMeasu+  28))  //RS485通讯8正常
#define usDBmRS485Msg0Norma9       (*((INT16U*)aDBMeasu+  29))  //RS485通讯9正常

#define usDBmCANMsg0Norma0         (*((INT16U*)aDBMeasu+  30))  //CAN通讯0正常
#define usDBmCANMsg0Norma1         (*((INT16U*)aDBMeasu+  31))  //CAN通讯1正常
#define usDBmCANMsg0Norma2         (*((INT16U*)aDBMeasu+  32))  //CAN通讯2正常
#define usDBmCANMsg0Norma3         (*((INT16U*)aDBMeasu+  33))  //CAN通讯3正常
#define usDBmCANMsg0Norma4         (*((INT16U*)aDBMeasu+  34))  //CAN通讯4正常
#define usDBmCANMsg0Norma5         (*((INT16U*)aDBMeasu+  35))  //CAN通讯5正常
#define usDBmCANMsg0Norma6         (*((INT16U*)aDBMeasu+  36))  //CAN通讯6正常
#define usDBmCANMsg0Norma7         (*((INT16U*)aDBMeasu+  37))  //CAN通讯7正常
#define usDBmCANMsg0Norma8         (*((INT16U*)aDBMeasu+  38))  //CAN通讯8正常
#define usDBmCANMsg0Norma9         (*((INT16U*)aDBMeasu+  39))  //CAN通讯9正常
