...
/*  SAE_VERSION  = 760x: GEC7600-Main Application                       */
/*  SAE_VERSION  = 761x: GEC7600-Display Application                    */
/*  SAE_VERSION  = 780x: GEC7800-Main Application                       */
/*  SAE_VERSION  = 781x: GEC7800-Display Application                    */
/*  SAE_VERSION  = 80xx: VEC8000 Application                            */
/*  SAE_VERSION  = 90xx: VEC9000 Application                            */
/*  SAE_VERSION  = 96xx: VEC9600 Application                            */
/* ******************************************************************** */

#define SAE_VERSION           7800
...
#define SAE_7600_MAIN_CHIP_ON    0
#define SAE_7600_AUX_CHIP_ON     0
#define SAE_7800_COMMON_ON       0
#define SAE_7800_MAIN_CHIP_ON    0
#define SAE_7800_AUX_CHIP_ON     0
...
#endif
#if   ((SAE_VERSION / 10)   == 760)
#undef  SAE_7600_MAIN_CHIP_ON
#define SAE_7600_MAIN_CHIP_ON    1
#endif
#if   ((SAE_VERSION / 10)   == 761)
#undef  SAE_7600_AUX_CHIP_ON
#define SAE_7600_AUX_CHIP_ON     1
#endif
#if   ((SAE_VERSION / 100)   == 78)
#undef  SAE_7800_COMMON_ON
#define SAE_7800_COMMON_ON       1
#endif
#if   ((SAE_VERSION / 10)   == 780)
#undef  SAE_7800_MAIN_CHIP_ON
#define SAE_7800_MAIN_CHIP_ON    1
#endif
#if   ((SAE_VERSION / 10)   == 781)
#undef  SAE_7800_AUX_CHIP_ON
#define SAE_7800_AUX_CHIP_ON     1
#endif
...
#define SAE_MY_ADDRESS          23
#endif
#if    (SAE_7600_MAIN_CHIP_ON == 1)
#undef  SAE_CPU_STM32F105_ON
#define SAE_CPU_STM32F105_ON     1
#endif
#if    (SAE_7600_AUX_CHIP_ON  == 1)
#undef  SAE_CPU_STM32F103_ON
#define SAE_CPU_STM32F103_ON     1
#endif
...
#define SAE_MY_ADDRESS          23
#endif
#if    (SAE_7800_MAIN_CHIP_ON == 1)
#undef  SAE_CPU_STM32F105_ON
#define SAE_CPU_STM32F105_ON     1
#endif
#if    (SAE_7800_AUX_CHIP_ON  == 1)
#undef  SAE_CPU_STM32F103_ON
#define SAE_CPU_STM32F103_ON     1
#endif
...
#define SAE_IGNORE_SPEED_ERROR  1
#define SAE_IGNORE_RACK_ERROR   0
#define SAE_PRESS_RELATIVE_ON   0
#define SAE_RX_PGN_MATCH_ON     0
#define SAE_TX_DM1_DM2_SPN_ON   0
#define SAE_RX_PGN_MAX          20
#define SAE_TX_PGN_MAX          2+9
#define SAE_RX_PGN_EEC1         0
#define SAE_RX_PGN_EEC2         1
#define SAE_RX_PGN_EEC3         2
#define SAE_RX_PGN_AMCON        3
...
#define SAE_TX_PGN_SELF00       2
#define SAE_TX_PGN_SELF01       3
#define SAE_TX_PGN_SELF02       4
#define SAE_TX_PGN_SELF03       5
#define SAE_TX_PGN_SELF04       6
#define SAE_TX_PGN_SELF05       7
#define SAE_TX_PGN_SELF06       8
#define SAE_TX_PGN_SELF07       9
#define SAE_TX_PGN_SELF08       10
#endif
...
#define SAE_STS_NORMAL         (INT32U)0x00000000
#define SAE_STS_RESET          (INT32U)0x00000001
#define SAE_STS_WARNING        (INT32U)0x00000002
#define SAE_STS_BUS_OFF        (INT32U)0x00000004
#define SAE_STS_SLEEPING       (INT32U)0x00000008
#define SAE_STS_OVERRUN        (INT32U)0x00000010
#define SAE_STS_TX_ERR         (INT32U)0x00000020
#define SAE_STS_RX_ERR         (INT32U)0x00000040
#define SAE_STS_GET_BIT(m)     (uiSAEStatus & (m))
#define SAE_STS_CLR_BIT(m)      uiSAEStatus &= ~(m) 
#define SAE_STS_SET_BIT(m)      uiSAEStatus |= (m)
...
#define SAE_ID_J1939_SELF00    (INT32U)0x12345678
#define SAE_ID_J1939_SELF01    (INT32U)0x12345678
#define SAE_ID_J1939_SELF02    (INT32U)0x12345678
#define SAE_ID_J1939_SELF03    (INT32U)0x12345678
#define SAE_ID_J1939_SELF04    (INT32U)0x12345678
#define SAE_ID_J1939_SELF05    (INT32U)0x12345678
#define SAE_ID_J1939_SELF06    (INT32U)0x12345678
#define SAE_ID_J1939_SELF07    (INT32U)0x12345678
#define SAE_ID_J1939_SELF08    (INT32U)0x12345678
...
#define SAE_ID32_TO_PGN16(x)    (INT16U)((x)>>8)
#define SAE_CPU_TO_PGN32(x)     ((x)&(INT32U)0xFFFFFF00)
#define SAE_CPU_TO_ADR08(x)     (INT08U)((x)&0x000000FF)
#endif
...
#define SAE_ID32_TO_PGN16(x)    (INT16U)((x)>>8)
#define SAE_CPU_TO_PGN32(x)     (((x)>>3)&(INT32U)0xFFFFFF00)
#define SAE_CPU_TO_ADR08(x)     (INT08U)(((x)>>3)&0x000000FF)
#endif
#define SAE_UC_LOW(w)           (INT08U)(w)
#define SAE_UC_HIGH(w)          (INT08U)((w)>>8)
#define SAE_US_CREAT(h,l)       ((INT16U)(l)+((INT16U)(h)<<8))
...
/*                          Function Definition                         */
/* ******************************************************************** */
SAE_EXT void   SAEInit(INT08U ucAddr);
...
SAE_EXT void SAEUpdateTxSELF00(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF01
SAE_EXT void SAEUpdateTxSELF01(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF02
SAE_EXT void SAEUpdateTxSELF02(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF03
SAE_EXT void SAEUpdateTxSELF03(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF04
SAE_EXT void SAEUpdateTxSELF04(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF05
SAE_EXT void SAEUpdateTxSELF05(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF06
SAE_EXT void SAEUpdateTxSELF06(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF07
SAE_EXT void SAEUpdateTxSELF07(CAN_MSG *pMsg);
#endif
#ifdef  SAE_TX_PGN_SELF08
SAE_EXT void SAEUpdateTxSELF08(CAN_MSG *pMsg);
#endif
