...
#define usDBpTimeOfStopperOutput   (*((INT16U*)aDBParam+155))
#define usDBpMainSwitchTryTimes    (*((INT16U*)aDBParam+156))
#define usDBpGensSwitchTryTimes    (*((INT16U*)aDBParam+157))
...
#define usDBpFixPwrGensPrsntMax    (*((INT16U*)aDBParam+185))
#define usDBpSyncBackup1           (*((INT16U*)aDBParam+186))
#define usDBpSyncBackup2           (*((INT16U*)aDBParam+187))
...
#define usDBpCanLeaderPrsntMin     (*((INT16U*)aDBParam+202))
#define usDBpCanLeaderPrsntMax     (*((INT16U*)aDBParam+203))
#define usDBpCanBackup1            (*((INT16U*)aDBParam+204))
#define usDBpCanBackup2            (*((INT16U*)aDBParam+205))
...
#define usDBpAdcFftChannel         (*((INT16U*)aDBParam+292))
#define usDBpAdcBackup1            (*((INT16U*)aDBParam+293))
#define usDBpAdcBackup2            (*((INT16U*)aDBParam+294))
#define usDBpAdcBackup3            (*((INT16U*)aDBParam+295))
...
#define usDBfMainCurrCtFunc        (*((INT16U*)aDBFunct+ 12))
#define usDBfMainBackup1           (*((INT16U*)aDBFunct+ 13))
#define usDBfMainBackup2           (*((INT16U*)aDBFunct+ 14))

/* **************** Part 2: Generator Setpint Functions *************** */
#define usDBfGensPhaseErrAct       (*((INT16U*)aDBFunct+ 15))
#define usDBfGensCurrShortErrAct   (*((INT16U*)aDBFunct+ 16))
#define usDBfGensCurrLongErrAct    (*((INT16U*)aDBFunct+ 17))
#define usDBfGensCurrGndErrAct     (*((INT16U*)aDBFunct+ 18))
#define usDBfGensCurrUnbErrAct     (*((INT16U*)aDBFunct+ 19))
#define usDBfGensActPwrErrAct      (*((INT16U*)aDBFunct+ 20))
#define usDBfGensReactPwrErrAct    (*((INT16U*)aDBFunct+ 21))
#define usDBfGensAppPwrErrAct      (*((INT16U*)aDBFunct+ 22))
#define usDBfGensInvPwrErrAct      (*((INT16U*)aDBFunct+ 23))
#define usDBfGensFactorErrAct      (*((INT16U*)aDBFunct+ 24))
#define usDBfGensMagLostErrAct     (*((INT16U*)aDBFunct+ 25))
#define usDBfGensBackup1           (*((INT16U*)aDBFunct+ 26))
#define usDBfGensBackup2           (*((INT16U*)aDBFunct+ 27))
...
#define usDBfEngStarterTestOn      (*((INT16U*)aDBFunct+ 32))
#define usDBfEngSpeedSource        (*((INT16U*)aDBFunct+ 33))
#define usDBfEngBackup1            (*((INT16U*)aDBFunct+ 34))
#define usDBfEngBackup2            (*((INT16U*)aDBFunct+ 35))

/* **************** Part 4: Timer Setpint Functions ******************* */
#define usDBfAmfMainSwOffBfrStart  (*((INT16U*)aDBFunct+ 36))
#define usDBfAmfSoftUnloadingOn    (*((INT16U*)aDBFunct+ 37))
#define usDBfMainSwKeyFuncOn       (*((INT16U*)aDBFunct+ 38))
#define usDBfMainSwOutPulseOn      (*((INT16U*)aDBFunct+ 39))
#define usDBfMainSwFeedbackOn      (*((INT16U*)aDBFunct+ 40))
#define usDBfGensSwOutPulseOn      (*((INT16U*)aDBFunct+ 41))
#define usDBfGensSwFeedbackOn      (*((INT16U*)aDBFunct+ 42))
#define usDBfTimeBackup1           (*((INT16U*)aDBFunct+ 43))
#define usDBfTimeBackup2           (*((INT16U*)aDBFunct+ 44))
#define usDBfTimeBackup3           (*((INT16U*)aDBFunct+ 45))

/* **************** Part 5: Synchronization & Load share ************** */
#define usDBfFixPwrMainLoadCtrlOn  (*((INT16U*)aDBFunct+ 46))
#define usDBfSyncBackup2           (*((INT16U*)aDBFunct+ 47))
#define usDBfSyncBackup3           (*((INT16U*)aDBFunct+ 48))
#define usDBfSyncBackup4           (*((INT16U*)aDBFunct+ 49))

/* **************** Part 6: CanBus / ModBus *************************** */
#define usDBfCanBackup1            (*((INT16U*)aDBFunct+ 50))
#define usDBfCanBackup2            (*((INT16U*)aDBFunct+ 51))
#define usDBfCanBackup3            (*((INT16U*)aDBFunct+ 52))
#define usDBfCanBackup4            (*((INT16U*)aDBFunct+ 53))

/* **************** Part 7: Monitoring & Warn ************************* */
#define usDBfMntrOilPressCurveOn   (*((INT16U*)aDBFunct+ 54))
#define usDBfMntrBackup1           (*((INT16U*)aDBFunct+ 55))
#define usDBfMntrBackup2           (*((INT16U*)aDBFunct+ 56))
#define usDBfMntrBackup3           (*((INT16U*)aDBFunct+ 57))

/* **************** Part 8: Maintenance Functions ********************* */
#define usDBfMaintenanceStartOn    (*((INT16U*)aDBFunct+ 58))
#define usDBfMaintenanceStartOff   (*((INT16U*)aDBFunct+ 59))
#define usDBfMaintenanceBackup1    (*((INT16U*)aDBFunct+ 60))
#define usDBfMaintenanceBackup2    (*((INT16U*)aDBFunct+ 61))

/* **************** Part 9: Electric Functions ************************ */
#define usDBfAdcRefAutoOrFixed     (*((INT16U*)aDBFunct+ 62))
#define usDBfAdcBackup1            (*((INT16U*)aDBFunct+ 63))
#define usDBfAdcBackup2            (*((INT16U*)aDBFunct+ 64))
#define usDBfAdcBackup3            (*((INT16U*)aDBFunct+ 65))

/* **************** Part 10: Switch Assignment ************************ */
#define usDBfDinPoleEngineStop     (*((INT16U*)aDBFunct+ 66))
#define usDBfDinPoleEngineStart    (*((INT16U*)aDBFunct+ 67))
#define usDBfDinPoleMainFeedback   (*((INT16U*)aDBFunct+ 68))
#define usDBfDinPoleGensFeedback   (*((INT16U*)aDBFunct+ 69))
#define usDBfDinPoleOilPump        (*((INT16U*)aDBFunct+ 70))
#define usDBfDinPoleHeater         (*((INT16U*)aDBFunct+ 71))
#define usDBfDinPoleOilTemp        (*((INT16U*)aDBFunct+ 72))
#define usDBfDinPoleFuelLevel      (*((INT16U*)aDBFunct+ 73))
#define usDBfDinPoleOilPressure    (*((INT16U*)aDBFunct+ 74))
#define usDBfDinPoleCoolantTemp    (*((INT16U*)aDBFunct+ 75))
#define usDBfDinPoleCoolantLevel   (*((INT16U*)aDBFunct+ 76))
#define usDBfDinPoleAirFilter      (*((INT16U*)aDBFunct+ 77))
#define usDBfDinPoleEmergStop      (*((INT16U*)aDBFunct+ 78))
#define usDBfDinBackup1            (*((INT16U*)aDBFunct+ 79))
#define usDBfDinBackup2            (*((INT16U*)aDBFunct+ 80))
#define usDBfDinBackup3            (*((INT16U*)aDBFunct+ 81))
#define usDBfDinBackup4            (*((INT16U*)aDBFunct+ 82))
#define usDBfDinBackup5            (*((INT16U*)aDBFunct+ 83))
#define usDBfDinBackup6            (*((INT16U*)aDBFunct+ 84))
#define usDBfDinBackup7            (*((INT16U*)aDBFunct+ 85))

/* **************** Part 11: Sensor Assignment ************************ */
#define usDBfAinCoolTempSenErrAct  (*((INT16U*)aDBFunct+ 86))
#define usDBfAinOilTempSenErrAct   (*((INT16U*)aDBFunct+ 87))
#define usDBfAinOilPresSenErrAct   (*((INT16U*)aDBFunct+ 88))
#define usDBfAinFuelLevelSenErrAct (*((INT16U*)aDBFunct+ 89))
#define usDBfAinCoolLevelSenErrAct (*((INT16U*)aDBFunct+ 90))
#define usDBfAinChargCurrSenErrAct (*((INT16U*)aDBFunct+ 91))
#define usDBfAinBackup1            (*((INT16U*)aDBFunct+ 92))
#define usDBfAinBackup2            (*((INT16U*)aDBFunct+ 93))

/* **************** Part 12: Output Calibration *********************** */
#define usDBfDout1Pole             (*((INT16U*)aDBFunct+ 94))
#define usDBfDout2Pole             (*((INT16U*)aDBFunct+ 95))
#define usDBfDout3Pole             (*((INT16U*)aDBFunct+ 96))
#define usDBfDout4Pole             (*((INT16U*)aDBFunct+ 97))
#define usDBfDout5Pole             (*((INT16U*)aDBFunct+ 98))
#define usDBfDout6Pole             (*((INT16U*)aDBFunct+ 99))
#define usDBfDout7Pole             (*((INT16U*)aDBFunct+100))
#define usDBfDout8Pole             (*((INT16U*)aDBFunct+101))
#define usDBfDout9Pole             (*((INT16U*)aDBFunct+102))
#define usDBfDout10Pole            (*((INT16U*)aDBFunct+103))
#define usDBfDout11Pole            (*((INT16U*)aDBFunct+104))
#define usDBfDout12Pole            (*((INT16U*)aDBFunct+105))
#define usDBfDout13Pole            (*((INT16U*)aDBFunct+106))
#define usDBfDout14Pole            (*((INT16U*)aDBFunct+107))
#define usDBfDout15Pole            (*((INT16U*)aDBFunct+108))
#define usDBfDout16Pole            (*((INT16U*)aDBFunct+109))

/* **************** Part 13: Reserved ********************************* */
#define usDBfReserved1             (*((INT16U*)aDBFunct+110))
#define usDBfReserved2             (*((INT16U*)aDBFunct+111))
#define usDBfReserved3             (*((INT16U*)aDBFunct+112))
#define usDBfReserved4             (*((INT16U*)aDBFunct+113))
#define usDBfReserved5             (*((INT16U*)aDBFunct+114))
#define usDBfReserved6             (*((INT16U*)aDBFunct+115))
#define usDBfReserved7             (*((INT16U*)aDBFunct+116))
#define usDBfReserved8             (*((INT16U*)aDBFunct+117))
#define usDBfReserved9             (*((INT16U*)aDBFunct+118))
#define usDBfReserved10            (*((INT16U*)aDBFunct+119))
...
#define usDBmEngStopperOutput      (*((INT16U*)aDBMeasu+ 95))
#define usDBmEngBeeperOutput       (*((INT16U*)aDBMeasu+ 96))
...
#define usDBmSysMainSwStatus       (*((INT16U*)aDBMeasu+108))
...
#define usDBmSysGensSwStatus       (*((INT16U*)aDBMeasu+112))
...
#define usDBmFftDistortion         (*((INT16U*)aDBMeasu+294))
#define usDBmMeasuBackup1          (*((INT16U*)aDBMeasu+295))
#define usDBmMeasuBackup2          (*((INT16U*)aDBMeasu+296))
#define usDBmMeasuBackup3          (*((INT16U*)aDBMeasu+297))
#define usDBmMeasuBackup4          (*((INT16U*)aDBMeasu+298))
#define usDBmMeasuBackup5          (*((INT16U*)aDBMeasu+299))

/* **************** Part 13: Reserved ********************************* */
#define usDBm1939EngSpeed          (*((INT16U*)aDBMeasu+300))
#define usDBm1939EngLoad           (*((INT16U*)aDBMeasu+301))
#define usDBm1939EngPedal          (*((INT16U*)aDBMeasu+302))
#define usDBm1939EngConfig         (*((INT16U*)aDBMeasu+303))
#define uiDBm1939EngHours          (*(INT32U*)(aDBMeasu+304))
#define uiDBm1939EngHours16L       (*((INT16U*)aDBMeasu+304))
#define uiDBm1939EngHours16H       (*((INT16U*)aDBMeasu+305))
#define usDBm1939SysVoltage        (*((INT16U*)aDBMeasu+306))
#define usDBm1939CoolantTemp       (*((INT16U*)aDBMeasu+307))
#define usDBm1939BoostTemp         (*((INT16U*)aDBMeasu+308))
#define usDBm1939BoostPres         (*((INT16U*)aDBMeasu+309))
#define usDBm1939OilTemp           (*((INT16U*)aDBMeasu+310))
#define usDBm1939OilPres           (*((INT16U*)aDBMeasu+311))
#define usDBm1939RailPres          (*((INT16U*)aDBMeasu+312))
#define usDBm1939FuelPres          (*((INT16U*)aDBMeasu+313))
#define usDBm1939FuelLevel         (*((INT16U*)aDBMeasu+314))
#define usDBm1939FuelRate          (*((INT16U*)aDBMeasu+315))
#define usDBm1939FuelEconomy       (*((INT16U*)aDBMeasu+316))
#define usDBm1939VehSpeed          (*((INT16U*)aDBMeasu+317))
#define usDBm1939LampStatus        (*((INT16U*)aDBMeasu+318))
#define usDBm1939ActFault          (*((INT16U*)aDBMeasu+319))
#define usDBm1939HisFault          (*((INT16U*)aDBMeasu+320))
#define usDBm1939SpeedSetpoint     (*((INT16U*)aDBMeasu+321))
...
#define usDBhFuelLevelSum          (*((INT16U*)aDBMeasu+384))
#define usDBhFuelLevelOld          (*((INT16U*)aDBMeasu+385))
