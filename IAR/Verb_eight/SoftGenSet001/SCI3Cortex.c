...
{   uiSCI3Status    = 0;
    ...
    {   uiSCI3BaudRate = 1200uL;
    }   else if (usDBpModBus1Baudrate == 1)
    {   uiSCI3BaudRate = 2400uL;
    }   else if (usDBpModBus1Baudrate == 2)
    {   uiSCI3BaudRate = 4800uL;
    }   else if (usDBpModBus1Baudrate == 3)
    {   uiSCI3BaudRate = 9600uL;
    }   else if (usDBpModBus1Baudrate == 4)
    {   uiSCI3BaudRate = 19200uL;
    }   else if (usDBpModBus1Baudrate == 5)
    {   uiSCI3BaudRate = 38400uL;
    }   else if (usDBpModBus1Baudrate == 6)
    {   uiSCI3BaudRate = 57600uL;
    }   else if (usDBpModBus1Baudrate == 7)
    {   uiSCI3BaudRate = 115200uL;
    }   else
    {   uiSCI3BaudRate = SCI3_BAUDRATE_DEF;
    }
    if (uiSCI3BaudRate >= 19200uL)
    {   usSCI3OverTime2P5 = (INT16U)(10000000uL / uiSCI3BaudRate +  750);
        usSCI3OverTime2P0 = 1000;
        usSCI3OverTime4P5 = (INT16U)(10000000uL / uiSCI3BaudRate + 1750);
        usSCI3OverTime1P5 = (INT16U)(10000000uL / uiSCI3BaudRate +  250);
        usSCI3OverTime4P0 = (INT16U)(10000000uL / uiSCI3BaudRate + 1500);
    }   else
    {   usSCI3OverTime2P5 = (INT16U)(25000000uL / uiSCI3BaudRate);
        usSCI3OverTime2P0 = (INT16U)(20000000uL / uiSCI3BaudRate);
        usSCI3OverTime4P5 = (INT16U)(45000000uL / uiSCI3BaudRate);
        usSCI3OverTime1P5 = (INT16U)(15000000uL / uiSCI3BaudRate);
        usSCI3OverTime4P0 = (INT16U)(40000000uL / uiSCI3BaudRate);
    }
...
void SCI3Stop (void)
{
   #if (SCI3_SCI_TX_DMA_ON == 1) || (SCI3_SCI_RX_DMA_ON == 1)
    SCI3_SCI_TX_DIS();
    SCI3_SCI_TC_INT_DIS();
    SCI3_SCI_RX_DIS();
    SCI3_SCI_RX_INT_DIS();
