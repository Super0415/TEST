...
{   uiXIOStatus = 0;
    ...
    uiXIOAdcRefSum9 = (INT32U)usXIOAdcChRef9 * XIO_ADC_REF_FILTER;
    ...
    SFSoftFreqInit(&sXIOSoftFreq9, usDBpAdcChFilter9);
    SFHardFreqInit(&sXIOHardFreq0);
    SFHardFreqInit(&sXIOHardFreq1);
    SFSpeedPulseInit(&sXIOSpdPulse0, usDBpEngTeethCrank1, usDBpEngSpeedFilter1);
   #ifdef XIO_FRQ_PT_SPEED_IN2
    SFSpeedPulseInit(&sXIOSpdPulse1, usDBpEngTeethCrank2, usDBpEngSpeedFilter2);
   #endif
    (void)XIORemapJTAG();
...
/* ******************************************************************** */
void XIOStop (void)
{   (void)XIOStopTim1AdcTriger();
    (void)XIOStopDma1Ch1Adc();
}
...
/* ******************************************************************** */
void XIOReset (void)
{   (void)XIOAdc1ClearFlags();
    (void)XIOAdc1ReadResult();
    (void)XIOResetDma1Ch1Adc();
    (void)XIOInitTim1AdcTriger();
}
...
{   INT16U usBeg, usSiz, usTmp;
    (void)FWWatchdogInit();
    while (1)
    {   (void)OSTaskSuspend(OS_PRIO_SELF);
        (void)FWWatchdogFeed();
        usXIOCalcTimer = XIO_GET_FREE_TIMER();
        /* ************************************************************ */
        /*                     Read Analog Input                        */
        /* ************************************************************ */
        ...
        {   usXIOAdcChRef0 = SFGetAdcRef16u(usDBmAdcInput0, &uiXIOAdcRefSum0);
            ...
            usXIOAdcChRef9 = SFGetAdcRef16u(usDBmAdcInput9, &uiXIOAdcRefSum9);
        }
        /* ************************************************************ */
        /*                      Data Sub Reference                      */
        /* ************************************************************ */
        ...
        (void)SFSubRef16s(ssXIOAdcChDat9, usXIOAdcChRef9, XIO_ADC_SMPL_SIZ);
        /* ************************************************************ */
        /*                     Adjust Data Array                        */
        /* ************************************************************ */
        ...
        (void)SFCopy16s(&ssXIOAdcArray8[XIO_ADC_SMPL_SIZ],
                        &ssXIOAdcArray8[0],
                        XIO_ADC_ARRAY_SIZ-XIO_ADC_SMPL_SIZ);
        (void)SFCopy16s(&ssXIOAdcArray9[XIO_ADC_SMPL_SIZ],
                        &ssXIOAdcArray9[0],
                        XIO_ADC_ARRAY_SIZ-XIO_ADC_SMPL_SIZ);
        /* ************************************************************ */
        ...
        (void)SFCopy16s(&ssXIOAdcChDat8[0],
                        ...
                        XIO_ADC_SMPL_SIZ);
        (void)SFCopy16s(&ssXIOAdcChDat9[0],
                        &ssXIOAdcArray9[XIO_ADC_ARRAY_SIZ-XIO_ADC_SMPL_SIZ],
                        XIO_ADC_SMPL_SIZ);
        /* ************************************************************ */
        ...
        (void)SFSoftFreqRefresh(&ssXIOAdcChDat2[0],
                                &sXIOSoftFreq2, XIO_ADC_SMPL_SIZ);
        (void)SFSoftFreqRefresh(&ssXIOAdcChDat4[0],
                                &sXIOSoftFreq4, XIO_ADC_SMPL_SIZ);
        (void)SFSoftFreqRefresh(&ssXIOAdcChDat5[0],
                                &sXIOSoftFreq5, XIO_ADC_SMPL_SIZ);
        (void)SFSoftFreqRefresh(&ssXIOAdcChDat7[0],
                                &sXIOSoftFreq7, XIO_ADC_SMPL_SIZ);
        (void)SFSoftFreqRefresh(&ssXIOAdcChDat8[0],
                                &sXIOSoftFreq8, XIO_ADC_SMPL_SIZ);
        /* ************************************************************ */
        /*                     Get Period and Phase                     */
        /* ************************************************************ */
        uiXIOSoftPrdMainA  = sXIOSoftFreq1.uiTPrd;
        usXIOSoftFreqMainA = sXIOSoftFreq1.usFreq;
        usXIOSoftPhsMainA  = sXIOSoftFreq1.usPhase;
        uiXIOSoftPrdMainB  = sXIOSoftFreq4.uiTPrd;
        usXIOSoftFreqMainB = sXIOSoftFreq4.usFreq;
        usXIOSoftPhsMainB  = sXIOSoftFreq4.usPhase;
        uiXIOSoftPrdMainC  = sXIOSoftFreq7.uiTPrd;
        usXIOSoftFreqMainC = sXIOSoftFreq7.usFreq;
        usXIOSoftPhsMainC  = sXIOSoftFreq7.usPhase;
        uiXIOSoftPrdGensA  = sXIOSoftFreq2.uiTPrd;
        usXIOSoftFreqGensA = sXIOSoftFreq2.usFreq;
        usXIOSoftPhsGensA  = sXIOSoftFreq2.usPhase;
        uiXIOSoftPrdGensB  = sXIOSoftFreq5.uiTPrd;
        usXIOSoftFreqGensB = sXIOSoftFreq5.usFreq;
        usXIOSoftPhsGensB  = sXIOSoftFreq5.usPhase;
        uiXIOSoftPrdGensC  = sXIOSoftFreq8.uiTPrd;
        usXIOSoftFreqGensC = sXIOSoftFreq8.usFreq;
        usXIOSoftPhsGensC  = sXIOSoftFreq8.usPhase;
        ...
        if (usDBmMainVoltA < usDBpMainVoltLostLow)
        {   usXIOSoftFreqMainA = 0;
        }
        if (usDBmGensVoltA < usDBpMainVoltLostLow)
        {   usXIOSoftFreqGensA = 0;
        }
        /* ************************************************************ */
        /*                     Get Hard Period                          */
        ...
        usXIOAdcChEff47  = SFSubEffAve(&ssXIOAdcArray4[usBeg],
                                       &ssXIOAdcArray7[usBeg], usSiz);
        usXIOAdcChEff147 = SFTriEffAve(&ssXIOAdcArray1[usBeg],
                                       &ssXIOAdcArray4[usBeg],
                                       &ssXIOAdcArray7[usBeg], usSiz);
        usDBmMainVoltA   = SF_GET_VOLT_LN(usXIOAdcChEff1, usDBpAdcAmpMainVoltA);
        usDBmMainVoltB   = SF_GET_VOLT_LN(usXIOAdcChEff4, usDBpAdcAmpMainVoltB);
        usDBmMainVoltC   = SF_GET_VOLT_LN(usXIOAdcChEff7, usDBpAdcAmpMainVoltC);
        usDBmMainVoltAB  = SF_GET_VOLT_LL(usXIOAdcChEff14,usDBpAdcAmpMainVoltAB);
        usDBmMainVoltBC  = SF_GET_VOLT_LL(usXIOAdcChEff17,usDBpAdcAmpMainVoltBC);
        usDBmMainVoltCA  = SF_GET_VOLT_LL(usXIOAdcChEff47,usDBpAdcAmpMainVoltCA);
        usTmp            = (usDBpAdcAmpMainVoltA +
                            usDBpAdcAmpMainVoltB + usDBpAdcAmpMainVoltC) / 3;
        usDBmMainVoltUnb = SF_GET_VOLT_LN(usXIOAdcChEff147, usTmp);
        if (XIO_STS_GET_BIT(XIO_STS_HARDPRD0_ERR) == 0)
        {   usDBmMainFreq = usXIOHardFreqMainA;
        }   else
        {   usDBmMainFreq = usXIOSoftFreqMainA;
        }
        /* ************************************************************ */
        /*                      Main Current and Power                  */
        /* ************************************************************ */
        if (usDBfMainCurrCtFunc == CTL_CT4FUNC_MAIN_A)
        {   usXIOAdcChEff0   = SFGetEffAve(&ssXIOAdcArray0[usBeg], usSiz);
            siXIOCrossMac01  = SFGetMacAve(&ssXIOAdcArray0[usBeg],
                                           &ssXIOAdcArray1[usBeg], usSiz);
            siXIOMainActPA   = SF_GET_ACT_PWR(siXIOCrossMac01,
                                              usDBpAdcAmpMainVoltA,
                                              usDBpAdcAmpMainCurrA,
                                              usDBpMainCurrCtRatio);
            siXIOMainActPB   = siXIOMainActPA;
            siXIOMainActPC   = siXIOMainActPA;
            siXIOMainActPAll = siXIOMainActPA * 3;
            /* ******************************************************** */
            /*                 Main Current                             */
            /* ******************************************************** */
            usDBmMainCurrA   = SF_GET_CURRENT(usXIOAdcChEff0,
                                              usDBpAdcAmpMainCurrA,
                                              usDBpMainCurrCtRatio);
            usDBmMainCurrB   = usDBmMainCurrA;
            usDBmMainCurrC   = usDBmMainCurrA;
            /* ******************************************************** */
            /*                 Main Act Power                           */
            /* ******************************************************** */
            if ((usDBmMainCurrA == 0) || (siXIOMainActPA <= 0))
            {   usDBmMainActPowerA = 0;
            }   else
            {   usDBmMainActPowerA = (INT16U)siXIOMainActPA;
            }
            usDBmMainActPowerB = usDBmMainActPowerA;
            usDBmMainActPowerC = usDBmMainActPowerA;
            if (usDBmMainCurrA == 0)
            {   usDBmMainActPowerAll = 0;
                usDBmMainInvPowerAll = 0;
            }   else if (siXIOMainActPAll >= 0)
            {   usDBmMainActPowerAll = (INT16U)siXIOMainActPAll;
                usDBmMainInvPowerAll = 0;
            }   else
            {   usDBmMainActPowerAll = 0;
                usDBmMainInvPowerAll = (INT16U)(-siXIOMainActPAll);
            }
            /* ******************************************************** */
            /*                 Main Apparent Power                      */
            /* ******************************************************** */
            usDBmMainAppPowerA = SF_GET_APP_PWR(usDBmMainVoltA, usDBmMainCurrA);
            usDBmMainAppPowerB = usDBmMainAppPowerA;
            usDBmMainAppPowerC = usDBmMainAppPowerA;
            usDBmMainAppPowerAll = usDBmMainAppPowerA * 3;
            /* ******************************************************** */
            /*                 Main React Power                         */
            /* ******************************************************** */
            usDBmMainReactPowerA = SF_GET_REACT_PWR(usDBmMainAppPowerA, usDBmMainActPowerA);
            usDBmMainReactPowerB = usDBmMainReactPowerA;
            usDBmMainReactPowerC = usDBmMainReactPowerA;
            usDBmMainReactPowerAll = usDBmMainReactPowerA * 3;
            /* ******************************************************** */
            /*                 Main Power Factor                        */
            /* ******************************************************** */
            usDBmMainPowerFactorA = SF_GET_PWR_FACT(usDBmMainActPowerA, usDBmMainAppPowerA);
            usDBmMainPowerFactorB = usDBmMainPowerFactorA;
            usDBmMainPowerFactorC = usDBmMainPowerFactorA;
            usDBmMainPowerFactorAll = usDBmMainPowerFactorA;
        }
        /* ************************************************************ */
        /*                      No Main Current CT                      */
        /* ************************************************************ */
        ...
        /*                          Main Others                         */
        /* ************************************************************ */
        if (usDBfMainCurrCtFunc == CTL_CT4FUNC_MAIN_GND)
        {   usXIOAdcChEff0   = SFGetEffAve(&ssXIOAdcArray0[usBeg], usSiz);
            usDBmMainCurrGnd = SF_GET_CURRENT(usXIOAdcChEff0,
                                              usDBpAdcAmpMainCurrGnd,
                                              usDBpMainCurrCtRatio);
        }   else
        {   usDBmMainCurrGnd = 0;
        }
        ...
        usXIOAdcChEff9   = SFGetEffAve(&ssXIOAdcArray9[usBeg], usSiz);
        usXIOAdcChEff25  = SFSubEffAve(&ssXIOAdcArray2[usBeg],
                                       &ssXIOAdcArray5[usBeg], usSiz);
        usXIOAdcChEff28  = SFSubEffAve(&ssXIOAdcArray2[usBeg],
                                       &ssXIOAdcArray8[usBeg], usSiz);
        usXIOAdcChEff58  = SFSubEffAve(&ssXIOAdcArray5[usBeg],
                                       &ssXIOAdcArray8[usBeg], usSiz);
        usXIOAdcChEff369 = SFTriEffAve(&ssXIOAdcArray3[usBeg],
                                       &ssXIOAdcArray6[usBeg],
                                       &ssXIOAdcArray9[usBeg], usSiz);
        usDBmGensVoltA   = SF_GET_VOLT_LN(usXIOAdcChEff2, usDBpAdcAmpGensVoltA);
        usDBmGensVoltB   = SF_GET_VOLT_LN(usXIOAdcChEff5, usDBpAdcAmpGensVoltB);
        usDBmGensVoltC   = SF_GET_VOLT_LN(usXIOAdcChEff8, usDBpAdcAmpGensVoltC);
        usDBmGensVoltAB  = SF_GET_VOLT_LL(usXIOAdcChEff25,usDBpAdcAmpGensVoltAB);
        usDBmGensVoltBC  = SF_GET_VOLT_LL(usXIOAdcChEff28,usDBpAdcAmpGensVoltBC);
        usDBmGensVoltCA  = SF_GET_VOLT_LL(usXIOAdcChEff58,usDBpAdcAmpGensVoltCA);
        usDBmGensCurrA   = SF_GET_CURRENT(usXIOAdcChEff3,
                                          usDBpAdcAmpGensCurrA,
                                          usDBpGensCurrCtRatio);
        usDBmGensCurrB   = SF_GET_CURRENT(usXIOAdcChEff6,
                                          usDBpAdcAmpGensCurrB,
                                          usDBpGensCurrCtRatio);
        usDBmGensCurrC   = SF_GET_CURRENT(usXIOAdcChEff9,
                                          usDBpAdcAmpGensCurrC,
                                          usDBpGensCurrCtRatio);
        usTmp            = (usDBpAdcAmpGensCurrA +
                            usDBpAdcAmpGensCurrB + usDBpAdcAmpGensCurrC) / 3;
        usDBmGensCurrUnb = SF_GET_CURRENT(usXIOAdcChEff369,
                                          usTmp,
                                          usDBpGensCurrCtRatio);
        ssDBmSyncVoltDiffer = usDBmGensVoltA - usDBmMainVoltA;
        if (XIO_STS_GET_BIT(XIO_STS_HARDPRD1_ERR) == 0)
        ...
        /*                       Gens Active Power                      */
        /* ************************************************************ */
        siXIOCrossMac23  = SFGetMacAve(&ssXIOAdcArray2[usBeg],
                                       &ssXIOAdcArray3[usBeg], usSiz);
        siXIOCrossMac56  = SFGetMacAve(&ssXIOAdcArray5[usBeg],
                                       &ssXIOAdcArray6[usBeg], usSiz);
        siXIOCrossMac89  = SFGetMacAve(&ssXIOAdcArray8[usBeg],
                                       &ssXIOAdcArray9[usBeg], usSiz);
        siXIOGensActPA   = SF_GET_ACT_PWR(siXIOCrossMac23,
                                          usDBpAdcAmpGensVoltA,
                                          usDBpAdcAmpGensCurrA,
                                          usDBpGensCurrCtRatio);
        siXIOGensActPB   = SF_GET_ACT_PWR(siXIOCrossMac56,
                                          usDBpAdcAmpGensVoltB,
                                          usDBpAdcAmpGensCurrB,
                                          usDBpGensCurrCtRatio);
        siXIOGensActPC   = SF_GET_ACT_PWR(siXIOCrossMac89,
                                          usDBpAdcAmpGensVoltC,
                                          usDBpAdcAmpGensCurrC,
                                          usDBpGensCurrCtRatio);
        siXIOGensActPAll = siXIOGensActPA + siXIOGensActPB + siXIOGensActPC;
        if ((usDBmGensCurrA == 0) || (siXIOGensActPA <= 0))
        {   usDBmGensActPowerA = 0;
        }   else
        {   usDBmGensActPowerA = (INT16U)siXIOGensActPA;
        }
        if ((usDBmGensCurrB == 0) || (siXIOGensActPB <= 0))
        {   usDBmGensActPowerB = 0;
        }   else
        {   usDBmGensActPowerB = (INT16U)siXIOGensActPB;
        }
        if ((usDBmGensCurrC == 0) || (siXIOGensActPC <= 0))
        {   usDBmGensActPowerC = 0;
        }   else
        {   usDBmGensActPowerC = (INT16U)siXIOGensActPC;
        }
        if ((usDBmGensCurrA == 0) && (usDBmGensCurrB == 0) && (usDBmGensCurrC == 0))
        {   usDBmGensActPowerAll = 0;
            usDBmGensInvPowerAll = 0;
        }   else if (siXIOGensActPAll >= 0)
        ...
        /*                          Gens Others                         */
        /* ************************************************************ */
        if (usDBfMainCurrCtFunc == CTL_CT4FUNC_GENS_GND)
        {   usXIOAdcChEff0   = SFGetEffAve(&ssXIOAdcArray0[usBeg], usSiz);
            usDBmGensCurrGnd = SF_GET_CURRENT(usXIOAdcChEff0,
                                              usDBpAdcAmpGensCurrGnd,
                                              usDBpMainCurrCtRatio);
        }   else
        {   usDBmGensCurrGnd = 0;
        }
        ...
        /* ************************************************************ */
        (void)SFSpeedPulseRefrash(&sXIOSpdPulse0);
        usDBmEngSpeedPickup1 = SFSpeedPulseGetSpd(&sXIOSpdPulse0);
       #ifdef XIO_FRQ_PT_SPEED_IN2
        (void)SFSpeedPulseRefrash(&sXIOSpdPulse1);
        usDBmEngSpeedPickup2 = SFSpeedPulseGetSpd(&sXIOSpdPulse1);
        usTmp = SF_MAX2(usDBmEngSpeedPickup1,usDBmEngSpeedPickup2);
       #else
        usDBmEngSpeedPickup2 = 0;
        usTmp = usDBmEngSpeedPickup1;
       #endif
        if ((usTmp != 0) || (usDBfEngSpeedSource == 0))
        {   usDBmEngSpeed = usTmp;
        }   else if (usDBfEngSpeedSource == 1)
        {   usDBmEngSpeed = usDBm1939EngSpeed;
        }   else if (usDBfEngSpeedSource == 2)
        {   usDBmEngSpeed = (INT16U)((INT32U)usDBmGensFreq * 3 / 10);
        }   else
        {   usDBmEngSpeed = 0;
        }
        usDBmSwitchesInput = XIOReadSwitchesInput();
        usDBmBoardKeyInput = XIOReadBoardKeyInput();
        ...
        /*                          If FFT Needs                        */
        /* ************************************************************ */
        usTmp = usDBpAdcFftChannel;
        if ((usTmp <= 8) && (FFT_STS_GET_BIT(FFT_STS_BUFF_BUSY) == 0))
        {   if (usTmp == 0)
            {   pXIOFftDatBuf = &ssXIOAdcChDat0[0];
            }   else if (usTmp == 1)
            ...
            {   pXIOFftDatBuf = &ssXIOAdcChDat9[0];
            }
        ...
        usXIOCalcTime = XIO_GET_FREE_TIMER() - usXIOCalcTimer;
    }
}
...
{   INT32U uiNumb, uiSize;
    ...
    while (uiSize--)
    {   ssXIOAdcChDat0[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat1[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat2[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat3[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat4[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat5[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat6[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat7[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat8[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat9[uiNumb]  = *pDmaBuf++;
        ssXIOAdcChDat10[uiNumb] = *pDmaBuf++;
        ssXIOAdcChDat11[uiNumb] = *pDmaBuf++;
        ssXIOAdcChDat12[uiNumb] = *pDmaBuf++;
        ssXIOAdcChDat13[uiNumb] = *pDmaBuf++;
        ssXIOAdcChDat14[uiNumb] = *pDmaBuf++;
        ssXIOAdcChDat15[uiNumb] = *pDmaBuf++;
        uiNumb++;
    }
}
...
{   INT16U usInput = 0;
    ...
    {   usInput |= SF_KEY_MSK_ERROR_RESET;
    }
    if (XIO_GET_KEY_AUTO() == 0)
    {   usInput |= SF_KEY_MSK_MODE_AUTO;
    }
    if (XIO_GET_KEY_MANUAL() == 0)
    {   usInput |= SF_KEY_MSK_MODE_MANUAL;
    }
    if (XIO_GET_KEY_STOP() == 0)
    {   usInput |= SF_KEY_MSK_ENG_STOP;
    }
    if (XIO_GET_KEY_START() == 0)
    {   usInput |= SF_KEY_MSK_ENG_START;
    }
    if (XIO_GET_KEY_BEEPER() == 0)
    {   usInput |= SF_KEY_MSK_BEEPER;
    }
    if (XIO_GET_KEY_SW_ON() == 0)
    {   usInput |= SF_KEY_MSK_SWITCH_ON;
    }
    if (XIO_GET_KEY_SW_OFF() == 0)
    {   usInput |= SF_KEY_MSK_SWITCH_OFF;
    }
    return usInput;
}
...
{   if ((usOutput & SF_KEY_MSK_ERROR_RESET) != 0)
    {   XIO_LED_RESET_ON();
    }   else
    {   XIO_LED_RESET_OFF();
    }
    if ((usOutput & SF_KEY_MSK_MODE_AUTO) != 0)
    {   XIO_LED_AUTO_ON();
    }   else
    {   XIO_LED_AUTO_OFF();
    }
    if ((usOutput & SF_KEY_MSK_MODE_MANUAL) != 0)
    {   XIO_LED_MANUAL_ON();
    }   else
    {   XIO_LED_MANUAL_OFF();
    }
    if ((usOutput & SF_KEY_MSK_ENG_STOP) != 0)
    {   XIO_LED_STOP_ON();
    }   else
    {   XIO_LED_STOP_OFF();
    }
    if ((usOutput & SF_KEY_MSK_ENG_START) != 0)
    {   XIO_LED_START_ON();
    }   else
    {   XIO_LED_START_OFF();
    }
    if ((usOutput & SF_KEY_MSK_BEEPER) != 0)
    {   XIO_LED_BEEPER_ON();
    }   else
    {   XIO_LED_BEEPER_OFF();
    }
    if ((usOutput & SF_KEY_MSK_SWITCH_ON) != 0)
    {   XIO_LED_SW_ON_ON();
    }   else
    {   XIO_LED_SW_ON_OFF();
    }
    if ((usOutput & SF_KEY_MSK_SWITCH_OFF) != 0)
    {   XIO_LED_SW_OFF_ON();
    }   else
    {   XIO_LED_SW_OFF_OFF();
    }
...
{   XIOConfigGPIO(XIO_PT_KEY_RESET,  XIO_BT_KEY_RESET,  XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    XIOConfigGPIO(XIO_PT_KEY_AUTO,   XIO_BT_KEY_AUTO,   XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    XIOConfigGPIO(XIO_PT_KEY_MANUAL, XIO_BT_KEY_MANUAL, XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    XIOConfigGPIO(XIO_PT_KEY_STOP,   XIO_BT_KEY_STOP,   XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    XIOConfigGPIO(XIO_PT_KEY_START,  XIO_BT_KEY_START,  XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    XIOConfigGPIO(XIO_PT_KEY_BEEPER, XIO_BT_KEY_BEEPER, XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    XIOConfigGPIO(XIO_PT_KEY_SW_ON,  XIO_BT_KEY_SW_ON,  XIO_PT_GPI_PULL,  XIO_PT_SET_1);
    XIOConfigGPIO(XIO_PT_KEY_SW_OFF, XIO_BT_KEY_SW_OFF, XIO_PT_GPI_PULL,  XIO_PT_SET_1);
...
{   XIOConfigGPIO(XIO_PT_LED_RESET,  XIO_BT_LED_RESET,  XIO_PT_GPO_PP_02M, XIO_PT_SET_1);
    ...
    XIOConfigGPIO(XIO_PT_LED_BEEPER, XIO_BT_LED_BEEPER, XIO_PT_GPO_PP_02M, XIO_PT_SET_1);
...
/*                         XIOAdc1ClearFlags()                          */
/* ******************************************************************** */
void XIOAdc1ClearFlags (void)
{   ADC1->SR &= ~ADC_SR_EOC                    /* Conversion end flag   */
             &  ~ADC_SR_AWD                    /* Analog watchdog flag  */
             &  ~ADC_SR_JEOC                   /* Injected channel end  */
             &  ~ADC_SR_JSTRT                  /* Injected Start flag   */
             &  ~ADC_SR_STRT;                  /* Regular Start flag    */
}

/* ******************************************************************** */
/*                              XIOInitADC1()                           */
/* ******************************************************************** */
void XIOResetADC1 (void)
{   ADC1->CR2    &= ~ADC_CR2_ADON              /* A/D Converter OFF     */
                 &  ~ADC_CR2_CONT              /* Continuous Conversion */
                 &  ~ADC_CR2_CAL               /* A/D Calibration       */
                 &  ~ADC_CR2_DMA               /* DMA mode disable      */
...
{   RCC->AHBENR         |=  RCC_AHBENR_DMA1EN; /* 1: DMA clock enable   */
    ...
    DMA1_Channel1->CCR  |=  DMA_CCR1_MINC      /* Memory increment mode */
                        ...
                        |   DMA_CCR1_PL_0      /* 11: Priority Highest  */
                        |   DMA_CCR1_PL_1;     /* 11: Priority Highest  */
    DMA1->IFCR           =  DMA_ISR_GIF1       /* 1: clear Global flag  */
                        |   DMA_ISR_TCIF1      /* 1: clear TC flag      */
                        |   DMA_ISR_HTIF1      /* 1: clear HT flag      */
                        |   DMA_ISR_TEIF1;     /* 1: clear TE flag      */
...
/* ******************************************************************** */
/*                       XIOStopTim1AdcTriger()                         */
/* ******************************************************************** */
void XIOStopTim1AdcTriger (void)
{   TIM1->CCER    &= ~TIM_CCER_CC1E;         /* OC1 disable             */
    TIM1->EGR      =  TIM_EGR_UG;            /* UG: Update generation   */
    TIM1->BDTR    &= ~TIM_BDTR_MOE;          /* TIM1 Outputs enabled    */
    TIM1->CR1     &= ~TIM_CR1_CEN;           /* 1: Counter enabled      */
}
...
{   XIOConfigREMAP(XIO_TIM3_AFIO_REMAP1, XIO_TIM3_AFIO_REMAP2);
   ...
   #endif
    XIOConfigGPIO(XIO_FRQ_TEST_PT, XIO_FRQ_TEST_BT, XIO_PT_GPO_PP_02M, XIO_PT_SET_1);
    XIO_FRQ_TEST_OFF();
   ...
   #ifdef XIO_FRQ_PT_SPEED_IN2
    TIM3->CCMR1   |=  TIM_CCMR1_CC2S_0       /* 01: CC2 as input        */
   ...
   #ifdef XIO_FRQ_PT_SPEED_IN2
                  |   TIM_DIER_CC2IE         /* IC2 interrupt enable    */
   #endif
...
{   static INT16U usTimer1 = 0;
    ...
    {   usTimSr   =  TIM3->CCR1 - usTimer1;
        usTimer1  =  TIM3->CCR1;
        TIM3->SR &= ~TIM_SR_CC1IF;
        SFSpeedPulsePutPrd(&sXIOSpdPulse0, usTimSr);
    }
   #ifdef XIO_FRQ_PT_SPEED_IN2
    else if ((usTimSr & TIM_SR_CC2IF) != 0)
    {   usTimSr   =  TIM3->CCR2 - usTimer2;
        usTimer2  =  TIM3->CCR2;
        TIM3->SR &= ~TIM_SR_CC2IF;
        SFSpeedPulsePutPrd(&sXIOSpdPulse1, usTimSr);
    }
   #endif
    else if ((usTimSr & TIM_SR_CC3IF) != 0)
    {   TIM3->SR &= ~TIM_SR_CC3IF;
        SFHardFreqPutTime(TIM3->CCR3, &sXIOHardFreq1);
    }
    else if ((usTimSr & TIM_SR_CC4IF) != 0)
    {   TIM3->SR &= ~TIM_SR_CC4IF;
        SFHardFreqPutTime(TIM3->CCR4, &sXIOHardFreq0);
    }
}
...
{   XIOConfigREMAP(XIO_TIM4_AFIO_REMAP1, XIO_TIM4_AFIO_REMAP2);
    ...
    XIOConfigGPIO(GPIOD, XIO_PT_BT14, XIO_PT_ALT_PP_50M, XIO_PT_SET_0);
...
{   INT32U uiTmp;
    RCC->APB2ENR |=  RCC_APB2ENR_AFIOEN;
    uiTmp         =  AFIO->MAPR;
    uiTmp        &= ~(INT32U)0x07000000;
    uiTmp        |=  (INT32U)0x02000000;
    uiTmp        |=  uiRemap1;
    AFIO->MAPR    =  uiTmp;
    AFIO->MAPR2  |= uiRemap2;
}
