...
/* ******************************************************************** */
/* ************************** 0: VDO_163C ***************************** */
const INT16U aSFTempMap0Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(32),
      SF_OUM_TO_ADC(64),   SF_OUM_TO_ADC(96),
      SF_OUM_TO_ADC(128),  SF_OUM_TO_ADC(192),
      SF_OUM_TO_ADC(256),  SF_OUM_TO_ADC(480),
      SF_OUM_TO_ADC(600),  SF_OUM_TO_ADC(1000)
};
const INT16U aSFTempMap0Tmp[10] = 
{     SF_TMP_TO_16U(163),  SF_TMP_TO_16U(110),
      SF_TMP_TO_16U(85),   SF_TMP_TO_16U(73),
      SF_TMP_TO_16U(64),   SF_TMP_TO_16U(53),
      SF_TMP_TO_16U(44),   SF_TMP_TO_16U(35),
      SF_TMP_TO_16U(35),   SF_TMP_TO_16U(35)
};
/* ************************** 1: SGH_140C ***************************** */
const INT16U aSFTempMap1Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(19),
      SF_OUM_TO_ADC(32),   SF_OUM_TO_ADC(56),
      SF_OUM_TO_ADC(77),   SF_OUM_TO_ADC(106),
      SF_OUM_TO_ADC(217),  SF_OUM_TO_ADC(327),
      SF_OUM_TO_ADC(508),  SF_OUM_TO_ADC(600)
};
const INT16U aSFTempMap1Tmp[10] =
{     SF_TMP_TO_16U(140),  SF_TMP_TO_16U(140),
      SF_TMP_TO_16U(120),  SF_TMP_TO_16U(100),
      SF_TMP_TO_16U(90),   SF_TMP_TO_16U(80),
      SF_TMP_TO_16U(60),   SF_TMP_TO_16U(50),
      SF_TMP_TO_16U(40),   SF_TMP_TO_16U(40)
};
/* ************************** 2: SGD_180C ***************************** */
const INT16U aSFTempMap2Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(17),
      SF_OUM_TO_ADC(28),   SF_OUM_TO_ADC(36),
      SF_OUM_TO_ADC(64),   SF_OUM_TO_ADC(128),
      SF_OUM_TO_ADC(288),  SF_OUM_TO_ADC(732),
      SF_OUM_TO_ADC(800),  SF_OUM_TO_ADC(1000)
};
const INT16U aSFTempMap2Tmp[10] = 
{     SF_TMP_TO_16U(180),  SF_TMP_TO_16U(130),
      SF_TMP_TO_16U(110),  SF_TMP_TO_16U(100),
      SF_TMP_TO_16U(80),   SF_TMP_TO_16U(60),
      SF_TMP_TO_16U(40),   SF_TMP_TO_16U(20),
      SF_TMP_TO_16U(20),   SF_TMP_TO_16U(20)
};
/* ************************** 3: Curtis_140 *************************** */
const INT16U aSFTempMap3Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(47),
      SF_OUM_TO_ADC(77),   SF_OUM_TO_ADC(133),
      SF_OUM_TO_ADC(246),  SF_OUM_TO_ADC(480),
      SF_OUM_TO_ADC(480),  SF_OUM_TO_ADC(480),
      SF_OUM_TO_ADC(600),  SF_OUM_TO_ADC(1000)
};
const INT16U aSFTempMap3Tmp[10] = 
{     SF_TMP_TO_16U(140),  SF_TMP_TO_16U(120),
      SF_TMP_TO_16U(100),  SF_TMP_TO_16U(80),
      SF_TMP_TO_16U(60),   SF_TMP_TO_16U(35),
      SF_TMP_TO_16U(35),   SF_TMP_TO_16U(35),
      SF_TMP_TO_16U(35),   SF_TMP_TO_16U(35)
};
/* ************************** 4: Datcon_140C ************************** */
const INT16U aSFTempMap4Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(25),
      SF_OUM_TO_ADC(55),   SF_OUM_TO_ADC(76),
      SF_OUM_TO_ADC(106),  SF_OUM_TO_ADC(197),
      SF_OUM_TO_ADC(426),  SF_OUM_TO_ADC(952),
      SF_OUM_TO_ADC(952),  SF_OUM_TO_ADC(952)
};
const INT16U aSFTempMap4Tmp[10] = 
{     SF_TMP_TO_16U(140),  SF_TMP_TO_16U(140),
      SF_TMP_TO_16U(140),  SF_TMP_TO_16U(120),
      SF_TMP_TO_16U(100),  SF_TMP_TO_16U(80),
      SF_TMP_TO_16U(60),   SF_TMP_TO_16U(40),
      SF_TMP_TO_16U(40),   SF_TMP_TO_16U(40)
};
/* ************************** 5: VOLVO_EC_120C ************************ */
const INT16U aSFTempMap5Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(13),
      SF_OUM_TO_ADC(18),   SF_OUM_TO_ADC(23),
      SF_OUM_TO_ADC(32),   SF_OUM_TO_ADC(41),
      SF_OUM_TO_ADC(61),   SF_OUM_TO_ADC(102),
      SF_OUM_TO_ADC(220),  SF_OUM_TO_ADC(600)
};
const INT16U aSFTempMap5Tmp[10]   = 
{     SF_TMP_TO_16U(120),  SF_TMP_TO_16U(120),
      SF_TMP_TO_16U(110),  SF_TMP_TO_16U(100),
      SF_TMP_TO_16U(90),   SF_TMP_TO_16U(80),
      SF_TMP_TO_16U(70),   SF_TMP_TO_16U(60),
      SF_TMP_TO_16U(40),   SF_TMP_TO_16U(40)
};
/* ************************** 6: SGX_140C ***************************** */
const INT16U aSFTempMap6Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(21),
      SF_OUM_TO_ADC(28),   SF_OUM_TO_ADC(39),
      SF_OUM_TO_ADC(56),   SF_OUM_TO_ADC(116),
      SF_OUM_TO_ADC(258),  SF_OUM_TO_ADC(300),
      SF_OUM_TO_ADC(500),  SF_OUM_TO_ADC(1000)
};
const INT16U aSFTempMap6Tmp[10] = 
{     SF_TMP_TO_16U(140),  SF_TMP_TO_16U(110),
      SF_TMP_TO_16U(100),  SF_TMP_TO_16U(90),
      SF_TMP_TO_16U(80),   SF_TMP_TO_16U(60),
      SF_TMP_TO_16U(40),   SF_TMP_TO_16U(20),
      SF_TMP_TO_16U(20),   SF_TMP_TO_16U(20)
};
/* ************************** 7: PT100 ******************************** */
const INT16U aSFTempMap7Adc[10] =
{     SF_OUM_TO_ADC(100),  SF_OUM_TO_ADC(112),
      SF_OUM_TO_ADC(120),  SF_OUM_TO_ADC(127),
      SF_OUM_TO_ADC(135),  SF_OUM_TO_ADC(139),
      SF_OUM_TO_ADC(147),  SF_OUM_TO_ADC(155),
      SF_OUM_TO_ADC(162),  SF_OUM_TO_ADC(170)
};
const INT16U aSFTempMap7Tmp[10]   = 
{     SF_TMP_TO_16U(0),    SF_TMP_TO_16U(30),
      SF_TMP_TO_16U(50),   SF_TMP_TO_16U(70),
      SF_TMP_TO_16U(90),   SF_TMP_TO_16U(100),
      SF_TMP_TO_16U(120),  SF_TMP_TO_16U(140),
      SF_TMP_TO_16U(160),  SF_TMP_TO_16U(180)
};
/* ************************** 8: EURO-3 ******************************* */
const INT16U aSFTempMap8Adc[10] =
{     SF_OUM_TO_ADC(115),  SF_OUM_TO_ADC(146),
      SF_OUM_TO_ADC(188),  SF_OUM_TO_ADC(245),
      SF_OUM_TO_ADC(333),  SF_OUM_TO_ADC(435),
      SF_OUM_TO_ADC(596),  SF_OUM_TO_ADC(1175),
      SF_OUM_TO_ADC(2500), SF_OUM_TO_ADC(5896)
};
const INT16U aSFTempMap8Tmp[10] =
{     SF_TMP_TO_16U(120),  SF_TMP_TO_16U(110),
      SF_TMP_TO_16U(100),  SF_TMP_TO_16U(90),
      SF_TMP_TO_16U(80),   SF_TMP_TO_16U(70),
      SF_TMP_TO_16U(60),   SF_TMP_TO_16U(40),
      SF_TMP_TO_16U(20),   SF_TMP_TO_16U(0)
};
/* ************************** 9,10,11: Reserved *********************** */
...
/* ******************************************************************** */
/* ************************** 0: SGH ********************************** */
const INT16U aSFLevelMap0Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(20),
      SF_OUM_TO_ADC(40),   SF_OUM_TO_ADC(80),
      SF_OUM_TO_ADC(100),  SF_OUM_TO_ADC(120),
      SF_OUM_TO_ADC(160),  SF_OUM_TO_ADC(200),
      SF_OUM_TO_ADC(400),  SF_OUM_TO_ADC(500)
};
const INT16U aSFLevelMap0Lvl[10] =
{     0,    100,
      200,  400,
      500,  600,
      800,  1000,
...
/* ************************** 1: SGD ********************************** */
const INT16U aSFLevelMap1Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(20),
      SF_OUM_TO_ADC(40),   SF_OUM_TO_ADC(80),
      SF_OUM_TO_ADC(100),  SF_OUM_TO_ADC(120),
      SF_OUM_TO_ADC(160),  SF_OUM_TO_ADC(200),
...
const INT16U aSFLevelMap1Lvl[10] = 
{     0,    100,
      200,  400,
      500,  600,
      800,  1000,
...
/* ************************** 2: YW-ES-8-2S *************************** */
const INT16U aSFLevelMap2Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(18),
      SF_OUM_TO_ADC(36),   SF_OUM_TO_ADC(72),
      SF_OUM_TO_ADC(90),   SF_OUM_TO_ADC(108),
      SF_OUM_TO_ADC(144),  SF_OUM_TO_ADC(180),
      SF_OUM_TO_ADC(400),  SF_OUM_TO_ADC(500)
};
const INT16U aSFLevelMap2Lvl[10] =
{     1000, 900,
      800,  600,
      500,  400,
      200,  0,
...
/* ************************** 3: YW-ES-12-2S ************************** */
const INT16U aSFLevelMap3Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(45),
      SF_OUM_TO_ADC(90),   SF_OUM_TO_ADC(135),
      SF_OUM_TO_ADC(180),  SF_OUM_TO_ADC(225),
      SF_OUM_TO_ADC(300),  SF_OUM_TO_ADC(400),
      SF_OUM_TO_ADC(500),  SF_OUM_TO_ADC(700)
};
const INT16U aSFLevelMap3Lvl[10] =
{     1000, 800,
      600,  400,
      200,  0,
      0,    0,
...
/* ************************** 4: ZHM ********************************** */
const INT16U aSFLevelMap4Adc[10] =
{     SF_OUM_TO_ADC(10),   SF_OUM_TO_ADC(20),
      SF_OUM_TO_ADC(25),   SF_OUM_TO_ADC(31),
      SF_OUM_TO_ADC(36),   SF_OUM_TO_ADC(41),
      SF_OUM_TO_ADC(46),   SF_OUM_TO_ADC(57),
      SF_OUM_TO_ADC(72),   SF_OUM_TO_ADC(100)
};
const INT16U aSFLevelMap4Lvl[10] =
{     1000, 900,
      800,  700,
      600,  500,
      400,  300,
...
/* ******************************************************************** */
/* ************************** 0: VDO_10bar **************************** */
const INT16U aSFPressMap0Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(16),
      SF_OUM_TO_ADC(32),   SF_OUM_TO_ADC(48),
      SF_OUM_TO_ADC(64),   SF_OUM_TO_ADC(96),
      SF_OUM_TO_ADC(128),  SF_OUM_TO_ADC(176),
      SF_OUM_TO_ADC(300),  SF_OUM_TO_ADC(600)
};
const INT16U aSFPressMap0Prs[10] =
{     0,    0,
      179,  241,
      338,  503,
      703,  1034,
...
/* ************************** 1: SGH_10bar **************************** */
const INT16U aSFPressMap1Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(25),
      SF_OUM_TO_ADC(35),   SF_OUM_TO_ADC(59),
      SF_OUM_TO_ADC(98),   SF_OUM_TO_ADC(134),
      SF_OUM_TO_ADC(192),  SF_OUM_TO_ADC(200),
      SF_OUM_TO_ADC(240),  SF_OUM_TO_ADC(600)
};
const INT16U aSFPressMap1Prs[10] =
{     0,    0,
      0,    200,
      400,  600,
      1000, 1000,
...
/* ************************** 2: SGD_10bar **************************** */
const INT16U aSFPressMap2Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(15),
      SF_OUM_TO_ADC(24),   SF_OUM_TO_ADC(48),
      SF_OUM_TO_ADC(88),   SF_OUM_TO_ADC(119),
      SF_OUM_TO_ADC(149),  SF_OUM_TO_ADC(177),
      SF_OUM_TO_ADC(200),  SF_OUM_TO_ADC(600)
};
const INT16U aSFPressMap2Prs[10] =
{     0,    0,
      0,    200,
      400,  600,
      800,  1000,
...
/* ************************** 3: Curtis_10bar ************************* */
const INT16U aSFPressMap3Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(10),
      SF_OUM_TO_ADC(49),   SF_OUM_TO_ADC(88),
      SF_OUM_TO_ADC(119),  SF_OUM_TO_ADC(149),
      SF_OUM_TO_ADC(178),  SF_OUM_TO_ADC(240),
      SF_OUM_TO_ADC(300),  SF_OUM_TO_ADC(600)
};
const INT16U aSFPressMap3Prs[10] =
{     0,    0,
      200,  400,
      600,  800,
      1000, 1000,
...
/* ************************** 4: Datcon_10bar ************************* */
const INT16U aSFPressMap4Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(38),
      SF_OUM_TO_ADC(62),   SF_OUM_TO_ADC(101),
      SF_OUM_TO_ADC(127),  SF_OUM_TO_ADC(160),
      SF_OUM_TO_ADC(206),  SF_OUM_TO_ADC(207),
      SF_OUM_TO_ADC(300),  SF_OUM_TO_ADC(600)
};
const INT16U aSFPressMap4Prs[10] = 
{     1034, 1034,
      758,  483,
      345,  207,
      69,   0,
...
/* ************************** 5: VOLVO_EC_10bar *********************** */
const INT16U aSFPressMap5Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(12),
      SF_OUM_TO_ADC(58),   SF_OUM_TO_ADC(93),
      SF_OUM_TO_ADC(124),  SF_OUM_TO_ADC(152),
      SF_OUM_TO_ADC(184),  SF_OUM_TO_ADC(250),
      SF_OUM_TO_ADC(251),  SF_OUM_TO_ADC(600)
};
const INT16U aSFPressMap5Prs[10] =
{     0,     0,
      200,   400,
      600,   800,
      1000,  1000,
...
/* ************************** 6: SGX_10bar **************************** */
const INT16U aSFPressMap6Adc[10] =
{     SF_OUM_TO_ADC(0),    SF_OUM_TO_ADC(15),
      SF_OUM_TO_ADC(30),   SF_OUM_TO_ADC(50),
      SF_OUM_TO_ADC(86),   SF_OUM_TO_ADC(100),
      SF_OUM_TO_ADC(132),  SF_OUM_TO_ADC(168),
      SF_OUM_TO_ADC(200),  SF_OUM_TO_ADC(600)
};
const INT16U aSFPressMap6Prs[10] =
{     0,     0,
      100,   200,
      400,   500,
      700,   1000,
...
/*                           SFFilter16Sum()                            */
/* ******************************************************************** */
INT16U SFFilter16Sum (INT16U usInput, INT16U *pRSum, INT16U usFilter)
{   INT16U usSum, usOut;
    if (usFilter == 0)
    {   return usInput;
    }
    usSum  = *pRSum;
    usOut  = usSum / usFilter;
    usSum += usInput;
    usSum -= usOut;
    *pRSum = usSum;
    return usOut;
...
/*                           SFFilter32Sum()                            */
/* ******************************************************************** */
INT16U SFFilter32Sum (INT16U usInput, INT32U *pRSum, INT16U usFilter)
{   INT32U uiSum, uiOut;
    if (usFilter == 0)
    {   return usInput;
    }
    uiSum  = *pRSum;
    uiOut  = uiSum / usFilter;
...
/*                         SFAdcFiltering()                             */
/* ******************************************************************** */
void SFAdcFiltering (INT16U *pIn, INT16U *pOut, INT16U *pFlt, INT32U *pSum, INT16U usSiz)
{   INT32U uiSum;
    INT16U usFilt;
    while (usSiz--)
    {   usFilt = *pFlt;
...
{   pHard->usTime  = 0;
    ...
    SFFill32u(&pHard->uiPeriod[0],0xFFFFFFFF,SF_HARD_PRD_DAT_SIZ);
}
...
/*                          SFFuelStealInit()                           */
/* ******************************************************************** */
void SFFuelStealInit (SF_FUEL_STEAL_STR *pLvl)
{   pLvl->usTime = usFW100msTimer;
    pLvl->pLevel = &pLvl->usLevel[0];
    SFFill16u(&pLvl->usLevel[0], usDBhFuelLevelOld, SF_FUELSTEAL_DSIZ);
}

/* ******************************************************************** */
/*                         SFFuelStealPutLvl()                          */
/* ******************************************************************** */
INT08U SFFuelStealPutLvl (SF_FUEL_STEAL_STR *pLvl, INT16U usLevel)
{   INT16U usTmp;
    INT16U *pTmp;
    usTmp = usFW100msTimer - pLvl->usTime;
    if (usTmp >= SF_FUELSTEAL_DELAY)
    {   usDBhFuelLevelOld = usLevel;
        pLvl->usTime  = usFW100msTimer;
        pTmp          = pLvl->pLevel;
        *pTmp++       = usLevel;
        if (pTmp     >= &pLvl->usLevel[SF_FUELSTEAL_DSIZ])
        {   pTmp      = &pLvl->usLevel[0];
        }
        pLvl->pLevel  = pTmp;
        usTmp         = *pTmp;
        ...
        usTmp        -= usLevel;
        return usTmp >= SF_FUELSTEAL_LMIN ? SF_TRUE : SF_FALSE;
    }
    return SF_FALSE;
}
...
/*                          SFSpeedPulseInit()                          */
/* ******************************************************************** */
void SFSpeedPulseInit (SF_SPD_PLS_STR *pSpd, INT16U usTeeth, INT16U usSpdNum)
{   if (usTeeth == 0)
    {   usTeeth  = 120;
    }
    if((usSpdNum <= 1) || (usSpdNum > SF_SPD_PLS_PRD_SIZ))
    {   usSpdNum  = SF_SPD_PLS_PRD_SIZ / 2;
    }
    pSpd->usTick      =  usFW5msTimer;
    pSpd->usSpeed     =  0;
    pSpd->usSpdCntMax =  usSpdNum - 1;
    pSpd->usSpdCnt    =  pSpd->usSpdCntMax;
    pSpd->uiSpdCst    = (((INT32U)usSpdNum * 1000000uL) / (INT32U)usTeeth) * 60uL;
    pSpd->uiPrdRst    = (INT32U)0xF0000000 / (INT32U)usSpdNum;
    pSpd->uiPrdSumRst = (INT32U)usSpdNum * pSpd->uiPrdRst;
    pSpd->uiPrdMax    =  pSpd->uiSpdCst / 2uL;
    pSpd->uiPrdMin    =  pSpd->uiSpdCst / 15000uL;
    pSpd->uiPrdSum    =  pSpd->uiPrdSumRst;
    SFFill32u(&pSpd->uiPrd[0], pSpd->uiPrdRst, usSpdNum);
}

/* ******************************************************************** */
/*                          SFSpeedPulseRefrash()                       */
/* ******************************************************************** */
INT08U SFSpeedPulseRefrash (SF_SPD_PLS_STR *pSpd)
{   INT16U usTmp;
    usTmp = usFW5msTimer - pSpd->usTick;
    if (usTmp > SF_SPD_PLS_RST_TICK)
    {   pSpd->usTick   = usFW5msTimer - (SF_SPD_PLS_RST_TICK + 1);
        usTmp          = pSpd->usSpdCntMax;
        pSpd->usSpdCnt = usTmp;
        pSpd->uiPrdSum = pSpd->uiPrdSumRst;
        SFFill32u(&pSpd->uiPrd[0], pSpd->uiPrdRst, (usTmp+1));
        return SF_FALSE;
    }
    return SF_TRUE;
}
...
/*                         SFSpeedPulseGetSpd()                         */
/* ******************************************************************** */
INT16U SFSpeedPulseGetSpd (SF_SPD_PLS_STR *pSpd)
{   INT16U usTemp;
    if ((pSpd->uiPrdSum > pSpd->uiPrdMin) &&
        (pSpd->uiPrdSum < pSpd->uiPrdMax) )
    {   usTemp = (INT16U)(pSpd->uiSpdCst / pSpd->uiPrdSum);
    }   else
    {   usTemp = 0;
    }
    pSpd->usSpeed = usTemp;
...
/*                         SFSpeedPulsePutPrd()                         */
/* ******************************************************************** */
void SFSpeedPulsePutPrd (SF_SPD_PLS_STR *pSpd, INT32U uiPNew)
{   INT16U usTmp;
    INT32U uiPrd;
    uiPrd   = (INT32U)(usFW5msTimer - pSpd->usTick);
    pSpd->usTick = usFW5msTimer;
    uiPNew &= (INT32U)0x0000FFFF;
    uiPrd  &= (INT32U)0x0000FFFF;
    if (uiPrd >= (INT32U)10)
    {   uiPrd *= (INT32U)1000000 / OS_TICKS_PER_SEC;
        uiPrd += (INT32U)0x00008000;
        uiPrd -= (INT32U)uiPNew;
        uiPrd &= (INT32U)0xFFFF0000;
        uiPrd += (INT32U)uiPNew;
    }   else
    {   uiPrd  = (INT32U)uiPNew;
    }
    if (uiPrd  >  pSpd->uiPrdRst)
    {   uiPrd  =  pSpd->uiPrdRst;
    }
    usTmp              = pSpd->usSpdCnt;
    pSpd->uiPrdSum    += uiPrd;
    pSpd->uiPrdSum    -= pSpd->uiPrd[usTmp];
    pSpd->uiPrd[usTmp] = uiPrd;
    if (usTmp != 0)
    {   pSpd->usSpdCnt = usTmp - 1;
    }   else
    {   pSpd->usSpdCnt = pSpd->usSpdCntMax;
    }
}
...
{   INT16U usTmp;
    ...
    */
    usDBmAinInternTemp   = SF_TMP_TO_16U(60);
    /* *********************** Coolant Temperature ******************** */
    ...
    else if (usTmp < (SF_NUM_OF_ANA_IN * 2))
    {   usDBmAinCoolantTemp = usDBm1939CoolantTemp;
    ...
    {   usDBmAinOilTemp = usDBm1939OilTemp;
    ...
    {   usDBmAinOilPres = usDBm1939OilPres;
    ...
    {   usTmp = pAin[usTmp];
        ...
        {   usTmp = SFGetSensorLevel(usTmp, usDBpAinFuelLevelSenType);
            usDBmAinFuelLevel = SFFilter16Sum(usTmp, &usDBhFuelLevelSum, 50);
            if (usDBfAinFuelLevelSenErrAct == 0)
...
{   INT16U usTmp;
    ...
    {   ERR_ES6_SET_BIT(ERR_ES6_STP_DIN_EMERG);
    }   else
    {   ERR_ES6_CLR_BIT(ERR_ES6_STP_DIN_EMERG);
    }
}
#endif
...
{   static INT16U usTimer1 = 0;
    ...
    {   if ((uiInput & SF_KEY_MSK_ENG_STOP) == 0)
        {   usTimer1 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer1) >= SF_KEY_CHECK_TICKS)
        {   usTimer1 = usTimNow;
            usDBmKeyEngineStop = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_ENG_STOP) != 0)
    {   usTimer1 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer1) >= SF_KEY_CHECK_TICKS)
    {   usTimer1 = usTimNow;
        usDBmKeyEngineStop = 0;
    }
    if (usDBmKeyEngineStart == 0)
    {   if ((uiInput & SF_KEY_MSK_ENG_START) == 0)
        {   usTimer2 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer2) >= SF_KEY_CHECK_TICKS)
        {   usTimer2 = usTimNow;
            usDBmKeyEngineStart = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_ENG_START) != 0)
    {   usTimer2 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer2) >= SF_KEY_CHECK_TICKS)
    {   usTimer2 = usTimNow;
    ...
    {   if ((uiInput & SF_KEY_MSK_MODE_AUTO) == 0)
        {   usTimer3 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer3) >= SF_KEY_CHECK_TICKS)
        {   usTimer3 = usTimNow;
            usDBmKeyModeAuto = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_MODE_AUTO) != 0)
    {   usTimer3 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer3) >= SF_KEY_CHECK_TICKS)
    {   usTimer3 = usTimNow;
    ...
    {   if ((uiInput & SF_KEY_MSK_MODE_MANUAL) == 0)
        {   usTimer4 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer4) >= SF_KEY_CHECK_TICKS)
        {   usTimer4 = usTimNow;
            usDBmKeyModeManual = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_MODE_MANUAL) != 0)
    {   usTimer4 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer4) >= SF_KEY_CHECK_TICKS)
    {   usTimer4 = usTimNow;
        usDBmKeyModeManual = 0;
    }
    if (usDBmKeyErrorReset == 0)
    {   if ((uiInput & SF_KEY_MSK_ERROR_RESET) == 0)
        {   usTimer5 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer5) >= SF_KEY_CHECK_TICKS)
        {   usTimer5 = usTimNow;
            usDBmKeyErrorReset = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_ERROR_RESET) != 0)
    {   usTimer5 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer5) >= SF_KEY_CHECK_TICKS)
    {   usTimer5 = usTimNow;
        usDBmKeyErrorReset = 0;
    }
    if (usDBmKeySwitchOn == 0)
    {   if ((uiInput & SF_KEY_MSK_SWITCH_ON) == 0)
        {   usTimer6 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer6) >= SF_KEY_CHECK_TICKS)
        {   usTimer6 = usTimNow;
            usDBmKeySwitchOn = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_SWITCH_ON) != 0)
    {   usTimer6 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer6) >= SF_KEY_CHECK_TICKS)
    {   usTimer6 = usTimNow;
    ...
    {   if ((uiInput & SF_KEY_MSK_SWITCH_OFF) == 0)
        {   usTimer7 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer7) >= SF_KEY_CHECK_TICKS)
        {   usTimer7 = usTimNow;
            usDBmKeySwitchOff = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_SWITCH_OFF) != 0)
    {   usTimer7 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer7) >= SF_KEY_CHECK_TICKS)
    {   usTimer7 = usTimNow;
    ...
    if (usDBmKeyBeeperOff == 0)
    {   if ((uiInput & SF_KEY_MSK_BEEPER) == 0)
        {   usTimer8 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer8) >= SF_KEY_CHECK_TICKS)
        {   usTimer8 = usTimNow;
            usDBmKeyBeeperOff = 1;
        }
    }
    else if ((uiInput & SF_KEY_MSK_BEEPER) != 0)
    {   usTimer8 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer8) >= SF_KEY_CHECK_TICKS)
    {   usTimer8 = usTimNow;
...
{   ERR_ES1_CLR_BIT(ERR_ES1_EMERG_MSK | ERR_ES1_STOP_MSK);
    ERR_ES2_CLR_BIT(ERR_ES2_EMERG_MSK | ERR_ES2_STOP_MSK);
    ERR_ES3_CLR_BIT(ERR_ES3_EMERG_MSK | ERR_ES3_STOP_MSK);
    ERR_ES4_CLR_BIT(ERR_ES4_EMERG_MSK | ERR_ES4_STOP_MSK);
    ERR_ES5_CLR_BIT(ERR_ES5_EMERG_MSK | ERR_ES5_STOP_MSK);
    ERR_ES6_CLR_BIT(ERR_ES6_EMERG_MSK | ERR_ES6_STOP_MSK);
    ERR_ES7_CLR_BIT(ERR_ES7_EMERG_MSK | ERR_ES7_STOP_MSK);
    ERR_ES8_CLR_BIT(ERR_ES8_EMERG_MSK | ERR_ES8_STOP_MSK);
    ERR_ES6_CLR_BIT(ERR_ES6_WRN_FUEL_STEAL);
    uiDBhErrorStatus1 = 0;
    uiDBhErrorStatus2 = 0;
    uiDBhErrorStatus3 = 0;
    uiDBhErrorStatus4 = 0;
...
{   INT32U uiMsk, uiErr;
    ...
    uiErr = ERR_ES1_GET_BIT(ERR_ES1_EMERG_MSK | ERR_ES1_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES1_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    uiErr = ERR_ES2_GET_BIT(ERR_ES2_EMERG_MSK | ERR_ES2_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES2_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    uiErr = ERR_ES3_GET_BIT(ERR_ES3_EMERG_MSK | ERR_ES3_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES3_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    uiErr = ERR_ES4_GET_BIT(ERR_ES4_EMERG_MSK | ERR_ES4_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES4_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    uiErr = ERR_ES5_GET_BIT(ERR_ES5_EMERG_MSK | ERR_ES5_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES5_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    uiErr = ERR_ES6_GET_BIT(ERR_ES6_EMERG_MSK | ERR_ES6_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES6_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    uiErr = ERR_ES7_GET_BIT(ERR_ES7_EMERG_MSK | ERR_ES7_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES7_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    uiErr = ERR_ES8_GET_BIT(ERR_ES8_EMERG_MSK | ERR_ES8_STOP_MSK);
    if (uiErr != 0)
    {   for (uiMsk = 0x80000000; uiMsk != 0; uiMsk >>= 1)
        {   if ((uiErr & uiMsk) != 0)
            {   ERR_ES8_CLR_BIT(uiMsk);
                return;
            }
        }
    }
    if (ERR_ES6_GET_BIT(ERR_ES6_WRN_FUEL_STEAL) != 0)
    {   ERR_ES6_CLR_BIT(ERR_ES6_WRN_FUEL_STEAL);
...
{   static INT16U usTimer1 = 0;
    ...
    /* ******************* Fuel Steal Warn **************************** */
    if (SFFuelStealPutLvl(&sSFFuelSteal,usDBmAinFuelLevel) != SF_FALSE)
    {   ERR_ES6_SET_BIT(ERR_ES6_WRN_FUEL_STEAL);
    }
    /* ******************* Cool Level Warn **************************** */
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFMonitorPowerOff (INT16U usVolt1, INT16U usVolt2)
{   static INT16U usTimer1 = 0;
    INT16U usTimNow;
    usTimNow = usFW5msTimer;
    if (usVolt1 < usVolt2)
    ...
    if (ERR_ES7_GET_BIT(ERR_ES7_SYS_PWR_ON) == 0)
    {   if (usVolt1 < SF_SYS_PWR_ON_VMIN)
        {   usTimer1 = usTimNow;
        }
        else if ((INT16U)(usTimNow-usTimer1) > SF_SYS_PWR_ON_TICKS)
        {   ERR_ES7_SET_BIT(ERR_ES7_SYS_PWR_ON);
            usTimer1 = usTimNow;
        }
    }
    else if (usVolt1 >= SF_SYS_PWR_OFF_VMAX)
    {   usTimer1 = usTimNow;
    }
    else if ((INT16U)(usTimNow-usTimer1) > SF_SYS_PWR_OFF_TICKS)
    {   ERR_ES7_CLR_BIT(ERR_ES7_SYS_PWR_ON);
        usTimer1 = usTimNow;
        return SF_TRUE;
    }
    return SF_FALSE;
...
{   static INT32U uiCount = 8;
    if (usSpeed > usDBpEngSpeedStart1)
    {   uiCount = 0;
        return 0;
    }
    else if (uiCount < 8)
...
{   static INT32U uiCount = 0;
    if (usSpeed <= usDBpEngSpeedStart2)
    {   uiCount = 0;
        return 0;
    }
    else if (uiCount < 8)
...
{   static INT16U usTimer1 = 0;
    ...
    if ((usPhase != CTL_PHASE_STARTING) ||
        ...
        (usDBmEngHeaterDuration == 0)  ||
        (usDBmSwitchHeater == 0))
    {   usTimer1 = usTimNow - SF_OFFTIME_HEATER;
        usActive = 0;
    }
    else if (usActive == 0)
    {   if (usDelay >= SF_OFFTIME_HEATER)
        {   usTimer1 = usTimNow;
            usActive = 1;
        }
    }
...
{   static INT16U usTimer1 = 0;
    ...
    {   usTimer1 = usFW100msTimer - SF_OFFTIME_OILPUMP;
        usActive = 0;
    }
    else if (usActive == 0)
    {   if (usDelay >= SF_OFFTIME_OILPUMP)
        {   usTimer1 = usFW100msTimer;
            usActive = 1;
        }
    }
...
{   static INT16U usTimer1 = 0;
    ...
    else if ((usAutoOrHand == 0) && (usDBfEngStarterTestOn != 0))
    {   if (usActive == 0)
        {   if ((usDelay >= usDBpTimeOfStarterOff) && (usDBmKeyEngineStart != 0))
            {   uiDBhStartTimes32B++;
                usTimer1 = usTimNow;
                usActive = 1;
            }
        }
        else if ((usDelay >= usDBpTimeOfStarterOn) || (usDBmKeyEngineStart == 0))
        {   usTimer1 = usTimNow;
            usActive = 0;
        }
    }
...
{   static INT16U usActive = 0;
    ...
    else if ((usPhase == CTL_PHASE_RAMP_UP) ||
             (usPhase == CTL_PHASE_RATED_UP) ||
             (usPhase == CTL_PHASE_RATED_DOWN) ||
             (usPhase == CTL_PHASE_WAIT_KEY_SW) ||
             (usPhase == CTL_PHASE_SYNCHRING) ||
             (usPhase == CTL_PHASE_SYNCHRING2) ||
             (usPhase == CTL_PHASE_LOADING_UP) ||
             (usPhase == CTL_PHASE_LOADING_DOWN) ||
             (usPhase == CTL_PHASE_FIXPWR_UP) ||
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFGetSwitchStatus (SF_SW_CTRL_STR *pSw)
{   return pSw->ucStatus;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFGetSwitchError (SF_SW_CTRL_STR *pSw)
{   return pSw->ucError;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFGetSwitchOnErr (SF_SW_CTRL_STR *pSw)
{   return (pSw->ucError & SF_SW_ERR_SWON);
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFGetSwitchOffErr (SF_SW_CTRL_STR *pSw)
{   return (pSw->ucError & SF_SW_ERR_SWOFF);
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFGetSwitchErrSum (SF_SW_CTRL_STR *pSw)
{   return pSw->ucErrSum;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFClrSwitchError (SF_SW_CTRL_STR *pSw)
{   pSw->ucError = SF_SW_NO_ERR;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFClrSwitchOnErr (SF_SW_CTRL_STR *pSw)
{   pSw->ucError &= ~SF_SW_ERR_SWON;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFClrSwitchOffErr (SF_SW_CTRL_STR *pSw)
{   pSw->ucError &= ~SF_SW_ERR_SWOFF;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFClrSwitchErrSum (SF_SW_CTRL_STR *pSw)
{   pSw->ucErrSum = 0;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFGetSwitchOnLock (SF_SW_CTRL_STR *pSw)
{   return (pSw->ucLocker & SF_SW_LOCK_SWON);
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT08U SFGetSwitchOffLock (SF_SW_CTRL_STR *pSw)
{   return (pSw->ucLocker & SF_SW_LOCK_SWOFF);
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFSetSwitchOnLock (SF_SW_CTRL_STR *pSw)
{   pSw->ucLocker |= SF_SW_LOCK_SWON;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFSetSwitchOffLock (SF_SW_CTRL_STR *pSw)
{   pSw->ucLocker |= SF_SW_LOCK_SWOFF;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFClrSwitchOnLock (SF_SW_CTRL_STR *pSw)
{   pSw->ucLocker &= ~SF_SW_LOCK_SWON;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFClrSwitchOffLock (SF_SW_CTRL_STR *pSw)
{   pSw->ucLocker &= ~SF_SW_LOCK_SWOFF;
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFSwitchOnTimes (SF_SW_CTRL_STR *pSw, INT08U ucTimes)
{   if(((pSw->ucLocker & SF_SW_LOCK_SWON) == 0) &&
        (pSw->ucStatus  == SF_SW_STS_SWOFF_ED) &&
        (pSw->ucComd    == SF_SW_CMD_HOLD) &&
        (pSw->ucComdOld == SF_SW_CMD_HOLD) )
    {   pSw->ucSwFails   =  0;
        pSw->ucSwFailMax =  ucTimes;
        pSw->ucError    &= ~SF_SW_ERR_SWON;
        pSw->ucComd      =  SF_SW_CMD_SWON;
    }
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFSwitchOffTimes (SF_SW_CTRL_STR *pSw, INT08U ucTimes)
{   if(((pSw->ucLocker & SF_SW_LOCK_SWOFF) == 0) &&
        (pSw->ucStatus  == SF_SW_STS_SWON_ED) &&
        (pSw->ucComd    == SF_SW_CMD_HOLD) &&
        (pSw->ucComdOld == SF_SW_CMD_HOLD) )
    {   pSw->ucSwFails   =  0;
        pSw->ucSwFailMax =  ucTimes;
        pSw->ucError    &= ~SF_SW_ERR_SWOFF;
        pSw->ucComd      =  SF_SW_CMD_SWOFF;
    }
}
#endif
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFUpdateSwitchLock (SF_SW_CTRL_STR *pMain, SF_SW_CTRL_STR *pGens)
{   if (usDBpSysOperationMode == CTL_MODE_PARALLEL)
    {   if (CAN2GetRxSwitchLockCmd() == CAN2_FALSE)
        {   pGens->ucLocker &= ~SF_SW_LOCK_SWON;
        }
        else if ((pGens->ucStatus == SF_SW_STS_SWON_ED) ||
                 (pGens->ucStatus == SF_SW_STS_SWOFF_ED))
        {   pGens->ucLocker |= SF_SW_LOCK_SWON;
        }
    }
    else
    {   if((pMain->ucStatus == SF_SW_STS_SWON_ING) ||
           (pMain->ucStatus == SF_SW_STS_SWOFF_ING))
        {   pGens->ucLocker  = SF_SW_LOCK_SWONOFF;
        }   else
        {   pGens->ucLocker  = SF_SW_NO_LOCK;
        }
        if((pGens->ucStatus == SF_SW_STS_SWON_ING) ||
           (pGens->ucStatus == SF_SW_STS_SWOFF_ING))
        {   pMain->ucLocker  = SF_SW_LOCK_SWONOFF;
        }   else
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
void SFUpdateSwitchCtrl (SF_SW_CTRL_STR *pSw, INT16U usFeedback)
{   INT16U usDelay, usTimNow;
    usTimNow      = usFW100msTimer;
    usDelay       = usTimNow - pSw->usTimer;
    pSw->usSwFeed = usFeedback;
    /* ************************ Switch_On ***************************** */
    if (pSw->ucComd == SF_SW_CMD_SWON)
    {   /* ******************** Sw_On_Locked ************************** */
        if ((pSw->ucLocker & SF_SW_LOCK_SWON) != 0)
        {   pSw->usTimer   = usTimNow;
            pSw->ucComd    = SF_SW_CMD_HOLD;
            pSw->ucComdOld = SF_SW_CMD_HOLD;
        }
        /* ******************** Sw_Pulse_Dis ************************** */
        else if (pSw->ucSwPulseEn == 0)
        {   /* **************** Sw_Feed_Dis *************************** */
            if (pSw->ucSwFeedEn == 0)
            {   if (pSw->ucStatus == SF_SW_STS_SWON_ED)
                {   pSw->usTimer   = usTimNow;
                    pSw->usSwOnOut = 1;
                    pSw->ucComd    = SF_SW_CMD_HOLD;
                    pSw->ucComdOld = SF_SW_CMD_HOLD;
                }
                else if (pSw->ucComd != pSw->ucComdOld)
                {   pSw->usTimer   = usTimNow;
                    pSw->usSwOnOut = 1;
                    pSw->ucStatus  = SF_SW_STS_SWON_ING;
                    pSw->ucComdOld = pSw->ucComd;
                }
                else if (usDelay  >= pSw->usSwOnPrd)
                {   pSw->usTimer   = usTimNow;
                    pSw->usSwOnOut = 1;
                    pSw->ucStatus  = SF_SW_STS_SWON_ED;
                    pSw->ucComd    = SF_SW_CMD_HOLD;
            ...
            else if (pSw->ucSwFails >= pSw->ucSwFailMax)
            {   pSw->usTimer   = usTimNow;
                pSw->usSwOnOut = 0;
                pSw->ucStatus  = SF_SW_STS_SWOFF_ED;
                pSw->ucError  |= SF_SW_ERR_SWON;
            ...
            else if (pSw->usSwOnOut != 0)
            {   if (usDelay       >= pSw->usSwOnPrd)
                {   pSw->usTimer   = usTimNow;
                    pSw->usSwOnOut = 0;
                    pSw->ucStatus  = SF_SW_STS_SWOFF_ING;
                }
            }
            else if (usDelay >= pSw->usSwOffPrd)
            {   pSw->usTimer  = usTimNow;
                pSw->ucStatus = SF_SW_STS_SWON_ING;
                pSw->ucSwFails += 1;
                pSw->ucErrSum  += 1;
                if (pSw->ucSwFails < pSw->ucSwFailMax)
                {   pSw->usSwOnOut = 1;
                }
            }
            pSw->usSwOffOut = pSw->usSwOnOut == 0 ? 1 : 0;
        }
        /* ******************** Sw_Pulse_En *************************** */
        /* ******************** Sw_Feed_Dis *************************** */
        else if (pSw->ucSwFeedEn == 0)
        {   if (pSw->ucStatus  == SF_SW_STS_SWON_ED)
            {   pSw->usTimer    = usTimNow;
                pSw->usSwOnOut  = 0;
                pSw->usSwOffOut = 0;
        ...
        else if (pSw->usSwOffOut != 0)
        {   if (usDelay >= pSw->usSwOffPrd)
            {   pSw->usTimer    = usTimNow;
                pSw->usSwOffOut = 0;
                pSw->ucStatus   = SF_SW_STS_SWON_ING;
            }
        }
        else if (pSw->ucStatus == SF_SW_STS_SWOFF_ING)
        {   if (usDelay >= SF_SW_DLY_ON_TO_OFF)
            {   pSw->usTimer    = usTimNow;
                pSw->usSwOffOut = 1;
            }
        }
        else if (pSw->ucStatus == SF_SW_STS_SWON_ING)
        {   if (usDelay >= SF_SW_DLY_OFF_TO_ON)
            {   pSw->usTimer    = usTimNow;
                pSw->ucSwFails += 1;
                pSw->ucErrSum  += 1;
                if (pSw->ucSwFails < pSw->ucSwFailMax)
    ...
    /* ************************ Switch_Off **************************** */
    else if (pSw->ucComd == SF_SW_CMD_SWOFF)
    {   /* ******************** Sw_On_Locked ************************** */
        if ((pSw->ucLocker & SF_SW_LOCK_SWOFF) != 0)
        {   pSw->usTimer   = usTimNow;
            pSw->ucComd    = SF_SW_CMD_HOLD;
        ...
        {   /* **************** Sw_Feed_Dis *************************** */
            if (pSw->ucSwFeedEn == 0)
            {   if (pSw->ucStatus == SF_SW_STS_SWOFF_ED)
                {   pSw->usTimer   = usTimNow;
                    pSw->usSwOnOut = 0;
                    pSw->ucComd    = SF_SW_CMD_HOLD;
                    pSw->ucComdOld = SF_SW_CMD_HOLD;
    ...
    {   if (pSw->ucStatus == SF_SW_STS_SWON_ED)
        {   if (pSw->usSwFeed != 0)
            ...
            else if (usDelay >= SF_SW_DLY_FEED_CHECK)
            {   pSw->usTimer  = usTimNow;
                pSw->ucStatus = SF_SW_STS_SWOFF_ED;
                if (pSw->ucSwPulseEn == 0)
                {   pSw->usSwOnOut  = 0;
                    pSw->usSwOffOut = 1;
                }
            }
        }
        else if (pSw->ucStatus == SF_SW_STS_SWOFF_ED)
        {   if (pSw->usSwFeed == 0)
            {   pSw->usTimer  = usTimNow;
            }
            else if (usDelay >= SF_SW_DLY_FEED_CHECK)
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT16U SFGetStopperActive (INT16U usPhase)
{   static INT16U usTimer1 = 0;
    static INT16U usActive = 0;
    INT16U usDelay, usTimNow;
    usTimNow = usFW100msTimer;
    ...
    if((usPhase != CTL_PHASE_STOPPING) &&
       (usPhase != CTL_PHASE_EMERGENCY) )
    {   usTimer1 = usTimNow - SF_OFFTIME_STOPPER;
        usActive = 0;
    }
    else if (usActive == 0)
    {   if (usDelay >= SF_OFFTIME_STOPPER)
        {   usTimer1 = usTimNow;
            usActive = 1;
        }
    }
    else if ((usDelay >= usDBpTimeOfStopperOutput) ||
...
/* ******************************************************************** */
#if (SF_GENS_FUNCTION_ON == 1)
INT16U SFGetBeeperActive (INT16U usMuteKey)
{   static INT16U usActive  = 0;
    static INT32U uiStatus1 = 0;
    static INT32U uiStatus2 = 0;
    static INT32U uiStatus3 = 0;
    static INT32U uiStatus4 = 0;
    static INT32U uiStatus5 = 0;
    static INT32U uiStatus6 = 0;
    INT32U uiTmp1, uiTmp2, uiTmp3, uiTmp4, uiTmp5, uiTmp6;
    uiTmp1 = ERR_ES1_GET_BIT(ERR_ES1_EMERG_MSK | ERR_ES1_STOP_MSK | ERR_ES1_WARN_MSK);
    uiTmp2 = ERR_ES2_GET_BIT(ERR_ES2_EMERG_MSK | ERR_ES2_STOP_MSK | ERR_ES2_WARN_MSK);
    uiTmp3 = ERR_ES3_GET_BIT(ERR_ES3_EMERG_MSK | ERR_ES3_STOP_MSK | ERR_ES3_WARN_MSK);
    uiTmp4 = ERR_ES4_GET_BIT(ERR_ES4_EMERG_MSK | ERR_ES4_STOP_MSK | ERR_ES4_WARN_MSK);
    uiTmp5 = ERR_ES5_GET_BIT(ERR_ES5_EMERG_MSK | ERR_ES5_STOP_MSK | ERR_ES5_WARN_MSK);
    uiTmp6 = ERR_ES6_GET_BIT(ERR_ES6_EMERG_MSK | ERR_ES6_STOP_MSK | ERR_ES6_WARN_MSK);
    if(((uiTmp1 == 0) && (uiTmp2 == 0)  &&
        (uiTmp3 == 0) && (uiTmp4 == 0)  &&
        (uiTmp5 == 0) && (uiTmp6 == 0)) || (usMuteKey != 0))
    {   usActive = 0;
    }
    else if(((uiTmp1 & ~uiStatus1) != 0) ||
            ((uiTmp2 & ~uiStatus2) != 0) ||
            ((uiTmp3 & ~uiStatus3) != 0) ||
            ((uiTmp4 & ~uiStatus4) != 0) ||
            ((uiTmp5 & ~uiStatus5) != 0) ||
