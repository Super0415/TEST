...
#define SF_GET_BATT_VOLT(d)    (INT16U)(((INT32U)(d) * 735) / 4095)
#define SF_GET_CHARG_VOLT(d)   (INT16U)(((INT32U)(d) * 735) / 4095)
...
/*                            Electric Switches                         */
/* ******************************************************************** */
#define SF_SW_STS_SWOFF_ED     (INT08U)0x00
#define SF_SW_STS_SWON_ED      (INT08U)0x01
#define SF_SW_STS_SWOFF_ING    (INT08U)0x02
#define SF_SW_STS_SWON_ING     (INT08U)0x03
#define SF_SW_CMD_HOLD         (INT08U)0x00
#define SF_SW_CMD_SWON         (INT08U)0x01
#define SF_SW_CMD_SWOFF        (INT08U)0x02
...
#define SF_SW_ERR_SWON         (INT08U)0x01
#define SF_SW_ERR_SWOFF        (INT08U)0x02
...
{   INT16U  usTick;
    ...
    INT32U  uiPrdMin;
    INT32U  uiPrdRst;
    INT32U  uiPrd[SF_SPD_PLS_PRD_SIZ];
}   SF_SPD_PLS_STR;
...
{   INT16U  usTime;
    INT16U  *pLevel;
    INT16U  usLevel[SF_FUELSTEAL_DSIZ];
}   SF_FUEL_STEAL_STR;
...
SF_EXT SF_FUEL_STEAL_STR sSFFuelSteal;
...
SF_EXT INT16U SFFilter16Sum(INT16U usInput, INT16U *pRSum, INT16U usFilter);
SF_EXT INT16U SFFilter32Sum(INT16U usInput, INT32U *pRSum, INT16U usFilter);
...
SF_EXT void   SFAdcFiltering(INT16U *pIn, INT16U *pOut, INT16U *pFlt, INT32U *pSum, INT16U usSiz);
...
SF_EXT void   SFFuelStealInit(SF_FUEL_STEAL_STR *pLvl);
SF_EXT INT08U SFFuelStealPutLvl(SF_FUEL_STEAL_STR *pLvl, INT16U usLevel);

SF_EXT void   SFSpeedPulseInit(SF_SPD_PLS_STR *pSpd, INT16U usTeeth, INT16U usSpdNum);
SF_EXT INT08U SFSpeedPulseRefrash(SF_SPD_PLS_STR *pSpd);
SF_EXT INT16U SFSpeedPulseGetSpd(SF_SPD_PLS_STR *pSpd);
SF_EXT void   SFSpeedPulsePutPrd(SF_SPD_PLS_STR *pSpd, INT32U uiPNew);
...
SF_EXT void   SFUpdateHstryStatus(void);
...
SF_EXT INT08U SFMonitorPowerOff(INT16U usVolt1, INT16U usVolt2);

SF_EXT INT08U SFGetSwitchStatus(SF_SW_CTRL_STR *pSw);
SF_EXT INT08U SFGetSwitchError(SF_SW_CTRL_STR *pSw);
SF_EXT INT08U SFGetSwitchOnErr(SF_SW_CTRL_STR *pSw);
SF_EXT INT08U SFGetSwitchOffErr(SF_SW_CTRL_STR *pSw);
SF_EXT INT08U SFGetSwitchErrSum(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFClrSwitchError(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFClrSwitchOnErr(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFClrSwitchOffErr(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFClrSwitchErrSum(SF_SW_CTRL_STR *pSw);
SF_EXT INT08U SFGetSwitchOnLock(SF_SW_CTRL_STR *pSw);
SF_EXT INT08U SFGetSwitchOffLock(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFSetSwitchOnLock(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFSetSwitchOffLock(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFClrSwitchOnLock(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFClrSwitchOffLock(SF_SW_CTRL_STR *pSw);
SF_EXT void   SFSwitchOnTimes(SF_SW_CTRL_STR *pSw, INT08U ucTimes);
SF_EXT void   SFSwitchOffTimes(SF_SW_CTRL_STR *pSw, INT08U ucTimes);
SF_EXT void   SFUpdateSwitchLock(SF_SW_CTRL_STR *pMain, SF_SW_CTRL_STR *pGens);
SF_EXT void   SFUpdateSwitchCtrl(SF_SW_CTRL_STR *pSw, INT16U usFeedback);
...
SF_EXT INT16U SFGetStopperActive(INT16U usPhase);
SF_EXT INT16U SFGetBeeperActive(INT16U usMuteKey);
