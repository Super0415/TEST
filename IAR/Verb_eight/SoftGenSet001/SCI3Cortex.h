...
#define SCI3_RE_RX_EN()         SCI3_RE_PT->BSRR = 1uL<< SCI3_RE_BT
#define SCI3_RE_RX_DIS()        SCI3_RE_PT->BSRR = 1uL<<(SCI3_RE_BT+16)

/* ******************************************************************** */
/*                           Hardware Difference                        */
/* ******************************************************************** */
#if    (SCI3_CPU_STM32F1_ON == 1)
#define SCI3_FRQ_CLK           (INT32U)36000000     /* PCLK1 for USART3 */
#define SCI3_SCI_RX_EN()        USART3->CR1 |=  USART_CR1_RE; SCI3_RE_RX_EN()
#define SCI3_SCI_RX_DIS()       USART3->CR1 &= ~USART_CR1_RE; SCI3_RE_RX_DIS()
...
SCI3_EXT void   SCI3Stop(void);
SCI3_EXT void   SCI3Reset(void);
