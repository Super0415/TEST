...
#define XIO_ADC_IN_MAIN_IA      (INT32U)15     /* Pin34, PC5, ADC1-Ch15 */
#define XIO_ADC_IN_MAIN_VA      (INT32U)13     /* Pin18, PC3, ADC1-Ch13 */
#define XIO_ADC_IN_MAIN_VB      (INT32U)4      /* Pin29, PA4, ADC1-Ch4  */
#define XIO_ADC_IN_MAIN_VC      (INT32U)5      /* Pin30, PA5, ADC1-Ch5  */
#define XIO_ADC_IN_GENS_VA      (INT32U)10     /* Pin15, PC0, ADC1-Ch10 */
#define XIO_ADC_IN_GENS_VB      (INT32U)11     /* Pin16, PC1, ADC1-Ch11 */
#define XIO_ADC_IN_GENS_VC      (INT32U)12     /* Pin17, PC2, ADC1-Ch12 */
...
#define XIO_ADC_IN_TEMP_10      (INT32U)0      /* Pin23, PA0, ADC1-Ch0  */
#define XIO_ADC_IN_TEMP_11      (INT32U)1      /* Pin24, PA1, ADC1-Ch1  */
#define XIO_ADC_IN_TEMP_12      (INT32U)2      /* Pin25, PA2, ADC1-Ch2  */
#define XIO_ADC_IN_TEMP_13      (INT32U)3      /* Pin26, PA3, ADC1-Ch3  */
#define XIO_ADC_IN_TEMP_14      (INT32U)8      /* Pin35, PB0, ADC1-Ch8  */
#define XIO_ADC_IN_TEMP_15      (INT32U)9      /* Pin36, PB1, ADC1-Ch9  */
#define XIO_ADC1_CH_1ST          XIO_ADC_IN_MAIN_IA
#define XIO_ADC1_CH_2ND          XIO_ADC_IN_MAIN_VA
#define XIO_ADC1_CH_3RD          XIO_ADC_IN_GENS_VA
#define XIO_ADC1_CH_4TH          XIO_ADC_IN_GENS_IA
#define XIO_ADC1_CH_5TH          XIO_ADC_IN_MAIN_VB
#define XIO_ADC1_CH_6TH          XIO_ADC_IN_GENS_VB
#define XIO_ADC1_CH_7TH          XIO_ADC_IN_GENS_IB
#define XIO_ADC1_CH_8TH          XIO_ADC_IN_MAIN_VC
#define XIO_ADC1_CH_9TH          XIO_ADC_IN_GENS_VC
#define XIO_ADC1_CH_10TH         XIO_ADC_IN_GENS_IC
...
#define XIO_ADC_NO_MAIN_IA      (INT32U)0
#define XIO_ADC_NO_MAIN_VA      (INT32U)1
#define XIO_ADC_NO_GENS_VA      (INT32U)2
#define XIO_ADC_NO_GENS_IA      (INT32U)3
#define XIO_ADC_NO_MAIN_VB      (INT32U)4
#define XIO_ADC_NO_GENS_VB      (INT32U)5
#define XIO_ADC_NO_GENS_IB      (INT32U)6
#define XIO_ADC_NO_MAIN_VC      (INT32U)7
#define XIO_ADC_NO_GENS_VC      (INT32U)8
#define XIO_ADC_NO_GENS_IC      (INT32U)9
...
#define XIO_FRQ_GPO_PT_TEST      PE8
#define XIO_FRQ_TEST_PT          GPIOE
#define XIO_FRQ_TEST_BT          8
#define XIO_FRQ_TEST_ON()        XIO_FRQ_TEST_PT->BRR  = 1<<XIO_FRQ_TEST_BT
#define XIO_FRQ_TEST_OFF()       XIO_FRQ_TEST_PT->BSRR = 1<<XIO_FRQ_TEST_BT
...
#define XIO_PWM_CH1_PT           PD13          /* Pin60, PD13, TIM4-CH2 */
#define XIO_PWM_CH2_PT           PD14          /* Pin61, PD14, TIM4-CH3 */
#define XIO_PWMOUT1_TIM4CH       2
#define XIO_PWMOUT2_TIM4CH       3

/* ******************************************************************** */
/*                            Key Inputs                                */
/* ******************************************************************** */
#define XIO_NUM_OF_KEY_IN        8
#define XIO_GPI_PT_KEY_RESET     PE3
#define XIO_PT_KEY_RESET         GPIOE
#define XIO_BT_KEY_RESET         3
#define XIO_GET_KEY_RESET()     (XIO_PT_KEY_RESET->IDR & (1<<XIO_BT_KEY_RESET))
#define XIO_GPI_PT_KEY_AUTO      PE5
#define XIO_PT_KEY_AUTO          GPIOE
#define XIO_BT_KEY_AUTO          5
#define XIO_GET_KEY_AUTO()      (XIO_PT_KEY_AUTO->IDR & (1<<XIO_BT_KEY_AUTO))
#define XIO_GPI_PT_KEY_MANUAL    PE4
#define XIO_PT_KEY_MANUAL        GPIOE
#define XIO_BT_KEY_MANUAL        4
#define XIO_GET_KEY_MANUAL()    (XIO_PT_KEY_MANUAL->IDR & (1<<XIO_BT_KEY_MANUAL))
#define XIO_GPI_PT_KEY_STOP      PD12
#define XIO_PT_KEY_STOP          GPIOD
#define XIO_BT_KEY_STOP          12
#define XIO_GET_KEY_STOP()      (XIO_PT_KEY_STOP->IDR & (1<<XIO_BT_KEY_STOP))
#define XIO_GPI_PT_KEY_START     PE9         /* Old: PC6 */
#define XIO_PT_KEY_START         GPIOE
#define XIO_BT_KEY_START         9
#define XIO_GET_KEY_START()     (XIO_PT_KEY_START->IDR & (1<<XIO_BT_KEY_START))
#define XIO_GPI_PT_KEY_BEEPER    PD10
#define XIO_PT_KEY_BEEPER        GPIOD
#define XIO_BT_KEY_BEEPER        10
#define XIO_GET_KEY_BEEPER()    (XIO_PT_KEY_BEEPER->IDR & (1<<XIO_BT_KEY_BEEPER))
#define XIO_GPI_PT_KEY_SW_ON     PE12
#define XIO_PT_KEY_SW_ON         GPIOE
#define XIO_BT_KEY_SW_ON         12
#define XIO_GET_KEY_SW_ON()     (XIO_PT_KEY_SW_ON->IDR & (1<<XIO_BT_KEY_SW_ON))
#define XIO_GPI_PT_KEY_SW_OFF    PE10
#define XIO_PT_KEY_SW_OFF        GPIOE
#define XIO_BT_KEY_SW_OFF        10
#define XIO_GET_KEY_SW_OFF()    (XIO_PT_KEY_SW_OFF->IDR & (1<<XIO_BT_KEY_SW_OFF))

/* ******************************************************************** */
/*                            Switch Inputs                             */
/* ******************************************************************** */
#define XIO_NUM_OF_DIN           7      /* Old:5,PC9,PD15,PB14,PB13,PE1 */
#define XIO_GPI_PT_DIN_CH1       PC7
#define XIO_PT_DIN_CH1           GPIOC
#define XIO_BT_DIN_CH1           7
#define XIO_GET_DIN_CH1()       (XIO_PT_DIN_CH1->IDR & (1<<XIO_BT_DIN_CH1))
#define XIO_GPI_PT_DIN_CH2       PD15
#define XIO_PT_DIN_CH2           GPIOD
#define XIO_BT_DIN_CH2           15
#define XIO_GET_DIN_CH2()       (XIO_PT_DIN_CH2->IDR & (1<<XIO_BT_DIN_CH2))
#define XIO_GPI_PT_DIN_CH3       PB14
#define XIO_PT_DIN_CH3           GPIOB
#define XIO_BT_DIN_CH3           14
#define XIO_GET_DIN_CH3()       (XIO_PT_DIN_CH3->IDR & (1<<XIO_BT_DIN_CH3))
#define XIO_GPI_PT_DIN_CH4       PB13
#define XIO_PT_DIN_CH4           GPIOB
#define XIO_BT_DIN_CH4           13
#define XIO_GET_DIN_CH4()       (XIO_PT_DIN_CH4->IDR & (1<<XIO_BT_DIN_CH4))
#define XIO_GPI_PT_DIN_CH5       PE1
#define XIO_PT_DIN_CH5           GPIOE
#define XIO_BT_DIN_CH5           1
#define XIO_GET_DIN_CH5()       (XIO_PT_DIN_CH5->IDR & (1<<XIO_BT_DIN_CH5))
#define XIO_GPI_PT_DIN_CH6       PA8
#define XIO_PT_DIN_CH6           GPIOA
#define XIO_BT_DIN_CH6           8
#define XIO_GET_DIN_CH6()       (XIO_PT_DIN_CH6->IDR & (1<<XIO_BT_DIN_CH6))
#define XIO_GPI_PT_DIN_CH7       PB12
#define XIO_PT_DIN_CH7           GPIOB
#define XIO_BT_DIN_CH7           12
#define XIO_GET_DIN_CH7()       (XIO_PT_DIN_CH7->IDR & (1<<XIO_BT_DIN_CH7))

/* ******************************************************************** */
/*                              Led Outputs                             */
/* ******************************************************************** */
#define XIO_NUM_OF_LED_OUT       8
#define XIO_GPO_PT_LED_RESET     PE2
#define XIO_PT_LED_RESET         GPIOE
#define XIO_BT_LED_RESET         2
...
#define XIO_GPO_PT_LED_AUTO      PC13
#define XIO_PT_LED_AUTO          GPIOC
#define XIO_BT_LED_AUTO          13
...
#define XIO_GPO_PT_LED_MANUAL    PE6
#define XIO_PT_LED_MANUAL        GPIOE
#define XIO_BT_LED_MANUAL        6
...
#define XIO_GPO_PT_LED_STOP      PB15
#define XIO_PT_LED_STOP          GPIOB
#define XIO_BT_LED_STOP          15
...
#define XIO_GPO_PT_LED_START     PE13         /* Old: PC7 */
#define XIO_PT_LED_START         GPIOE
#define XIO_BT_LED_START         13
...
#define XIO_GPO_PT_LED_BEEPER    PD9
#define XIO_PT_LED_BEEPER        GPIOD
#define XIO_BT_LED_BEEPER        9
#define XIO_LED_BEEPER_ON()      XIO_PT_LED_BEEPER->BRR  = 1<<XIO_BT_LED_BEEPER
#define XIO_LED_BEEPER_OFF()     XIO_PT_LED_BEEPER->BSRR = 1<<XIO_BT_LED_BEEPER
#define XIO_GPO_PT_LED_SW_ON     PE11
#define XIO_PT_LED_SW_ON         GPIOE
#define XIO_BT_LED_SW_ON         11
...
#define XIO_GPO_PT_LED_SW_OFF    PA15
#define XIO_PT_LED_SW_OFF        GPIOA
#define XIO_BT_LED_SW_OFF        15
...
/*                            Switch Outputs                            */
/* ******************************************************************** */
#define XIO_NUM_OF_DOUT          9  /* 8,PA12,11,10,PD3,PE0,PD4,PE7,PE8 */
#define XIO_GPO_PT_DOUT_CH1      PA12
#define XIO_PT_DOUT_CH1          GPIOA
...
#define XIO_GPO_PT_DOUT_CH2      PA11
#define XIO_PT_DOUT_CH2          GPIOA
#define XIO_BT_DOUT_CH2          11
...
#define XIO_GPO_PT_DOUT_CH3      PD2
#define XIO_PT_DOUT_CH3          GPIOD
#define XIO_BT_DOUT_CH3          2
...
#define XIO_GPO_PT_DOUT_CH4      PD3
#define XIO_PT_DOUT_CH4          GPIOD
#define XIO_BT_DOUT_CH4          3
...
#define XIO_GPO_PT_DOUT_CH5      PE0
#define XIO_PT_DOUT_CH5          GPIOE
#define XIO_BT_DOUT_CH5          0
...
#define XIO_GPO_PT_DOUT_CH6      PD8
#define XIO_PT_DOUT_CH6          GPIOD
#define XIO_BT_DOUT_CH6          8
...
#define XIO_GPO_PT_DOUT_CH7      PE7
#define XIO_PT_DOUT_CH7          GPIOE
#define XIO_BT_DOUT_CH7          7
...
#define XIO_GPO_PT_DOUT_CH8      PB8
#define XIO_PT_DOUT_CH8          GPIOB
#define XIO_BT_DOUT_CH8          8
...
#define XIO_GPO_PT_DOUT_CH9      PC12
#define XIO_PT_DOUT_CH9          GPIOC
...
XIO_EXT INT16U usXIOAdcChEff25;
XIO_EXT INT16U usXIOAdcChEff28;
XIO_EXT INT16U usXIOAdcChEff58;
XIO_EXT INT16U usXIOAdcChEff369;
XIO_EXT INT32S siXIOCrossMac01;
XIO_EXT INT32S siXIOCrossMac23;
XIO_EXT INT32S siXIOCrossMac56;
XIO_EXT INT32S siXIOCrossMac89;
XIO_EXT INT32S siXIOMainActPA;
XIO_EXT INT32S siXIOMainActPB;
XIO_EXT INT32S siXIOMainActPC;
XIO_EXT INT32S siXIOMainActPAll;
...
XIO_EXT INT16S ssXIOAdcArray9[XIO_ADC_ARRAY_SIZ];
...
XIO_EXT INT32U uiXIOAdcRefSum9;
...
XIO_EXT SF_SOFT_FREQ_STR sXIOSoftFreq9;
XIO_EXT SF_HARD_FREQ_STR sXIOHardFreq0;
XIO_EXT SF_HARD_FREQ_STR sXIOHardFreq1;
XIO_EXT SF_SPD_PLS_STR sXIOSpdPulse0;
#ifdef  XIO_FRQ_PT_SPEED_IN2
XIO_EXT SF_SPD_PLS_STR sXIOSpdPulse1;
#endif
...
XIO_EXT void   XIOStop(void);
XIO_EXT void   XIOReset(void);
...
XIO_EXT INT16U XIOAdc1ReadResult(void);
XIO_EXT void   XIOAdc1ClearFlags(void);
XIO_EXT void   XIOResetADC1(void);
XIO_EXT void   XIOInitDma1Ch1Adc(void);
XIO_EXT void   XIOStopDma1Ch1Adc(void);
XIO_EXT void   XIOResetDma1Ch1Adc(void);
...
XIO_EXT void   XIOStopTim1AdcTriger(void);
...
XIO_EXT void   XIORemapJTAG(void);
