...
#define SCI2_PROTOCOL_SPECIAL     1
#define SCI2_PROTOCOL_MODBUS      0
...
#define SCI2_FRQ_CLK           (INT32U)36000000     /* PCLK1 for USART2 */
...
#define SCI2_STS_ERR_TX        (INT32U)0x00000020
#define SCI2_STS_ERR_RX        (INT32U)0x00000040
#define SCI2_STS_ERR_ADDR      (INT32U)0x00000080
#define SCI2_STS_ERR_LOGIC     (INT32U)0x00000100
#define SCI2_STS_TO_1P5_ON     (INT32U)0x00000200
#define SCI2_STS_TO_2P5_ON     (INT32U)0x00000400
#define SCI2_STS_GET_BIT(m)    (uiSCI2Status & (m))
#define SCI2_STS_CLR_BIT(m)     uiSCI2Status &= ~(m)
#define SCI2_STS_SET_BIT(m)     uiSCI2Status |= (m)
#define SCI2_STEP_INIT         (INT08U)0
#define SCI2_STEP_IDLE         (INT08U)1
#define SCI2_STEP_RX_ING       (INT08U)2
#define SCI2_STEP_RX_WAIT      (INT08U)3
#define SCI2_STEP_TX_ING       (INT08U)4
#define SCI2_STEP_TX_WAIT      (INT08U)5
...
/*                          Control Definition                          */
/* ******************************************************************** */
#define SCI2_OVERTIME_TIMER     TIM2->CCR2
#define SCI2_MY_ADDRESS_DEF     1
...
SCI2_EXT INT32U uiSCI2Status;
SCI2_EXT INT08U ucSCI2CtrlStep;
SCI2_EXT INT08U ucSCI2RxByteCnt;
SCI2_EXT INT08U ucSCI2TxByteCnt;
SCI2_EXT INT16U usSCI2OverTime1P5;
SCI2_EXT INT16U usSCI2OverTime2P0;
SCI2_EXT INT16U usSCI2OverTime2P5;
SCI2_EXT INT16U usSCI2OverTime4P0;
SCI2_EXT INT16U usSCI2OverTime4P5;
SCI2_EXT INT32U uiSCI2BaudRate;
SCI2_EXT MODBUS_MSG sSCI2ModbusMsg;
#endif
/* ******************************************************************** */
/*                          Function Definition                         */
/* ******************************************************************** */
...
SCI2_EXT void   SCI2Stop(void);
SCI2_EXT void   SCI2Reset(void);
...
SCI2_EXT void   SCI2SetOverTimer(INT16U usDelay);
SCI2_EXT void   SCI2InitOverTimer(void);
