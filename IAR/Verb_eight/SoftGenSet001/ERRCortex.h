...
#define ERR_ES1_SET_BIT(m)       uiDBmErrorStatus1 |= (m)
...
#define ERR_ES1_MAIN_V_ERROR    ( ERR_ES1_STP_MAIN_VA_LOW \
                                | ERR_ES1_STP_MAIN_VA_HGH \
                                | ERR_ES1_STP_MAIN_VB_LOW \
                                | ERR_ES1_STP_MAIN_VB_HGH \
                                | ERR_ES1_STP_MAIN_VC_LOW \
...
#define ERR_ES2_STP_MAIN_SW_ON  (1UL << 8)
#define ERR_ES2_STP_MAIN_SW_OFF (1UL << 9)
...
#define ERR_ES2_WRN_MAIN_SW_ON  (1UL << 24)
#define ERR_ES2_WRN_MAIN_SW_OFF (1UL << 25)
...
#define ERR_ES2_STOP_MSK        ( ERR_ES2_STP_MAIN_SHRT_A \
                                ...
                                | ERR_ES2_STP_MAIN_SW_ON \
                                | ERR_ES2_STP_MAIN_SW_OFF )
#define ERR_ES2_WARN_MSK        ( ERR_ES2_WRN_MAIN_SHRT_A \
                                ...
                                | ERR_ES2_WRN_MAIN_SW_ON \
                                | ERR_ES2_WRN_MAIN_SW_OFF )

/* ******************************************************************** */
/*                     ERR3: Gens Voltage/Power                         */
/* ******************************************************************** */
#define ERR_ES3_GET_BIT(m)      (uiDBmErrorStatus3 & (m))
#define ERR_ES3_SET_BIT(m)       uiDBmErrorStatus3 |= (m)
...
#define ERR_ES4_STP_GENS_SW_ON  (1UL << 8)
#define ERR_ES4_STP_GENS_SW_OFF (1UL << 9)
...
#define ERR_ES4_WRN_GENS_SW_ON  (1UL << 24)
#define ERR_ES4_WRN_GENS_SW_OFF (1UL << 25)
...
#define ERR_ES4_STOP_MSK        ( ERR_ES4_STP_GENS_SHRT_A \
                                ...
                                | ERR_ES4_STP_GENS_SW_ON \
                                | ERR_ES4_STP_GENS_SW_OFF )
#define ERR_ES4_WARN_MSK        ( ERR_ES4_WRN_GENS_SHRT_A \
                                ...
                                | ERR_ES4_WRN_GENS_SW_ON \
                                | ERR_ES4_WRN_GENS_SW_OFF )
/* ******************************************************************** */
/*                            ERR5: Engine                              */
/* ******************************************************************** */
#define ERR_ES5_GET_BIT(m)      (uiDBmErrorStatus5 & (m))
#define ERR_ES5_SET_BIT(m)       uiDBmErrorStatus5 |= (m)
...
#define ERR_ES6_STP_CAN2_PRIO   (1UL << 10)
#define ERR_ES6_STP_CAN2_MODE   (1UL << 11)
#define ERR_ES6_STP_DIN_EMERG   (1UL << 12)
#define ERR_ES6_STP_FUEL_STEAL  (1UL << 13)
...
#define ERR_ES6_WRN_CAN2_PRIO   (1UL << 26)
#define ERR_ES6_WRN_CAN2_MODE   (1UL << 27)
#define ERR_ES6_WRN_DIN_EMERG   (1UL << 28)
#define ERR_ES6_WRN_FUEL_STEAL  (1UL << 29)
#define ERR_ES6_BACKUP9         (1UL << 30)
#define ERR_ES6_BACKUP10        (1UL << 31)
#define ERR_ES6_EMERG_MSK       (ERR_ES6_STP_DIN_EMERG)
#define ERR_ES6_STOP_MSK        ( ERR_ES6_STP_SEN_T_OIL \
                                ...
                                | ERR_ES6_STP_CAN1 \
                                | ERR_ES6_STP_CAN2_PRIO \
                                | ERR_ES6_STP_CAN2_MODE \
                                | ERR_ES6_STP_FUEL_STEAL )
#define ERR_ES6_WARN_MSK        ( ERR_ES6_WRN_SEN_T_OIL \
                                ...
                                | ERR_ES6_WRN_CAN1 \
                                | ERR_ES6_WRN_CAN2_PRIO \
                                | ERR_ES6_WRN_CAN2_MODE \
                                | ERR_ES6_WRN_FUEL_STEAL )
...
#define ERR_ES7_STS_ENG_WARM    (1UL << 6)
#define ERR_ES7_SYS_PWR_ON      (1UL << 7)
#define ERR_ES7_CMD_TO_STOP     (1UL << 8)
#define ERR_ES7_BACKUP2         (1UL << 9)
#define ERR_ES7_BACKUP3         (1UL << 10)
#define ERR_ES7_BACKUP4         (1UL << 11)
#define ERR_ES7_BACKUP5         (1UL << 12)
#define ERR_ES7_BACKUP6         (1UL << 13)
#define ERR_ES7_BACKUP7         (1UL << 14)
#define ERR_ES7_BACKUP8         (1UL << 15)
#define ERR_ES7_BACKUP9         (1UL << 16)
#define ERR_ES7_BACKUP10        (1UL << 17)
#define ERR_ES7_BACKUP11        (1UL << 18)
#define ERR_ES7_BACKUP12        (1UL << 19)
#define ERR_ES7_BACKUP13        (1UL << 20)
#define ERR_ES7_BACKUP14        (1UL << 21)
#define ERR_ES7_BACKUP15        (1UL << 22)
#define ERR_ES7_BACKUP16        (1UL << 23)
#define ERR_ES7_BACKUP17        (1UL << 24)
#define ERR_ES7_BACKUP18        (1UL << 25)
#define ERR_ES7_BACKUP19        (1UL << 26)
#define ERR_ES7_BACKUP20        (1UL << 27)
#define ERR_ES7_BACKUP21        (1UL << 28)
#define ERR_ES7_BACKUP22        (1UL << 29)
#define ERR_ES7_BACKUP23        (1UL << 30)
#define ERR_ES7_BACKUP24        (1UL << 31)
