...
{   INT16U usBeg, usSiz, usTim;
  ...
  //      (void)FWWatchdogFeed();
        ...
        /*                      Data Sub Reference                      */
        /* ************************************************************ */
        SFSubRef16s(ssXIOAdcChDat0, usXIOAdcChRef0, XIO_ADC_SMPL_SIZ);
        ...
        /* ************************************************************ */
        (void)SFGetIir16s(&ssXIOAdcChDat0[0],
                          &ssXIOAdcIirBuf0[0],
        ...
        usDBmGensVoltA  = SF_GET_VOLT_LN(usXIOAdcChEff1, usDBpAmpGensVoltA);
        usDBmGensVoltB  = SF_GET_VOLT_LN(usXIOAdcChEff4, usDBpAmpGensVoltB);
        usDBmGensVoltC  = SF_GET_VOLT_LN(usXIOAdcChEff7, usDBpAmpGensVoltC);
...
{   XIOConfigGPIO(GPIOA, XIO_PT_BT0, XIO_PT_GPI_ANALOG, XIO_PT_SET_0);//端口初始化
    ...
    ADC1->SQR3    = (XIO_ADC1_CH_1ST  << 0)    /* 1st  Chan in sequence */  //通道顺序MAIN_VA
                 |  (XIO_ADC1_CH_2ND  << 5)    /* 2nd  Chan in sequence */ //通道顺序GENS_VA
                 |  (XIO_ADC1_CH_3RD  << 10)   /* 3rd  Chan in sequence */ //通道顺序GENS_IA
