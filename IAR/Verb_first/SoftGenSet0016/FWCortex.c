...
/* ******************************************************************** */
#define XIOENBLE 1
uint32_t TESTZCIO1[10];
 int main (void)
{
 #ifndef  XIOENBLE 
 /* 
  XIOConfigREMAP(0x01<<24,0);
  TESTZCIO1[8] = 0x01<<24;
  TESTZCIO1[9] = AFIO_MAPR_SWJ_CFG_JTAGDISABLE;
 */ 
    RCC->APB2ENR |= RCC_APB2ENR_AFIOEN; 
    TESTZCIO1[0] = AFIO->MAPR;
    AFIO->MAPR   |= 2<<24;//0x02<<23;//AFIO_MAPR_SWJ_CFG_JTAGDISABLE;
    TESTZCIO1[1] = AFIO->MAPR;
    TESTZCIO1[2] = 2<<24;//0x02<<23;
    TESTZCIO1[3] = AFIO_MAPR_SWJ_CFG_JTAGDISABLE;
    //TESTZCIO1[4] = TESTZCIO1[0]+TESTZCIO1[2];
    //TESTZCIO1[5] = TESTZCIO1[0]| TESTZCIO1[2];
   // TESTZCIO1[6] = TESTZCIO1[0]+TESTZCIO1[3];   
  TESTZCIO1[8] +=1;
  while(1);
#endif
 #ifdef  XIOENBLE 
...
/*                         SCI1 Task ( Prio = 8 )                       */
/* ******************************************************************** */
void LED1_SetState(GPIO_TypeDef *pPt,INT08U ucBit,u8 usSet)
{    
    if (usSet    ==  0)
...
{   (void)FWWaitTaskSynchro(FW_SYN_MASK_SCI1,FW_SYN_MASK_ALL);
    (void)SCI1Start();
  //@@@@@@@@   
    LED1_SetState(GPIOA, XIO_PT_BT8,0);
//@@@@@@@@@  
    while (1)
    {   (void)SCI1TaskLoop();
    }
