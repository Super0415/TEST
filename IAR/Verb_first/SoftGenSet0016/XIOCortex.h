...
#define XIO_ADC_IN_MAIN_VA      (INT32U)13  //扫描通道0可设置
#define XIO_ADC_IN_GENS_VA      (INT32U)10  //扫描通道5-发电电压VA1
#define XIO_ADC_IN_GENS_IA      (INT32U)6  //发电电流A
#define XIO_ADC_IN_MAIN_VB      (INT32U)4
#define XIO_ADC_IN_GENS_VB      (INT32U)11  //扫描通道6-发电电压VB2
#define XIO_ADC_IN_GENS_IB      (INT32U)7  //发电电流B
#define XIO_ADC_IN_MAIN_VC      (INT32U)5
#define XIO_ADC_IN_GENS_VC      (INT32U)12  //扫描通道7-发电电压VC7
#define XIO_ADC_IN_GENS_IC      (INT32U)14  //发电电流C
#define XIO_ADC_IN_ENG_TMP      (INT32U)3  //扫描通道12-温度
#define XIO_ADC_IN_OIL_PRS      (INT32U)0  //扫描通道13-油压
#define XIO_ADC_IN_OIL_TMP      (INT32U)2
#define XIO_ADC_IN_TEMP_1       (INT32U)1  //扫描通道11-液位（输入口4）
#define XIO_ADC_IN_TEMP_2       (INT32U)15  //扫描通道10-输入口3
