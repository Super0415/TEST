...
void XIOInitDigInput (void)
{
  ...
  */
                                                                         //按键端口初始化
   XIOConfigGPIOKEY(GPIOE, XIO_PT_BT6, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //停机键 PE6
   XIOConfigGPIOKEY(GPIOE, XIO_PT_BT5, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //手动键 PE5
   XIOConfigGPIOKEY(GPIOD, XIO_PT_BT3, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //自动键 PD3
   XIOConfigGPIOKEY(GPIOC, XIO_PT_BT11, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //复位键 PC11
   XIOConfigGPIOKEY(GPIOC, XIO_PT_BT10, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //起机键 PC10
   XIOConfigGPIOKEY(GPIOB, XIO_PT_BT5, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //向下键 PB5
   XIOConfigGPIOKEY(GPIOB, XIO_PT_BT12, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //确认键 PB12
   XIOConfigGPIOKEY(GPIOB, XIO_PT_BT10, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //向上键 PB10
   
                                                                         //输入端口初始化
   XIOConfigGPIOKEY(GPIOE, XIO_PT_BT2, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //输入1 PE2
   XIOConfigGPIOKEY(GPIOE, XIO_PT_BT3, XIO_PT_GPI_PULL, XIO_PT_SET_1);   //输入2 PE3
}
...
/*                           XIOConfigGPIOKEY()                            */
/* @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ */
void XIOConfigGPIOKEY (GPIO_TypeDef *pPt, INT08U ucBit, INT32U uiMod, INT16U usSet)
{   if (pPt == GPIOA)
    {   RCC->APB2ENR |= RCC_APB2ENR_IOPAEN; //IO端口A时钟使能
    }   else if (pPt == GPIOB)
    {   RCC->APB2ENR |= RCC_APB2ENR_IOPBEN; //IO端口B时钟使能
